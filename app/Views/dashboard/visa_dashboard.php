...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="analytics">
            <div class="main-title pb-5">Visa <img class="float-right" src="<?= $template ?>assets/img/bismALLAH-hotel.png"> </div>
            <div class="row card-group-row">
                ...
                <div class="col-lg-6 col-md-12 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="pb-0 for-height hotel-sal-count">
                        <div class="row p-4">
                            <div class="col-lg-8 col-md-8 col-6">
                                <div class="title">Visa Category</div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-6">
                                <select class="select-count p-1 w-100">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                2,512</h4>
                                                            <div class="status-det">Visit/Touist</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                456</h4>
                                                            <div class="status-det">Business</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3 mt-lg-4 mt-md-4 mt-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                951</h4>
                                                            <div class="status-det">Residence</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3 mt-lg-4 mt-md-4 mt-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                157</h4>
                                                            <div class="status-det">Family Visa</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3 mt-lg-4 mt-md-4 mt-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                345</h4>
                                                            <div class="status-det">Study  Visa</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6 col-md-12 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Visa in Process</div>
            ...
            <div class="row mt-5">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Visa Issue</div>
                        <div class="price text-center">156</div>
                        <div class="yellow-box"></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Visa Reject</div>
                        <div class="price text-center">566</div>
                        <div class="red-box"></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Visa Cancel/Refund</div>
                        <div class="price text-center">245 / 200</div>
                        <div class="green-box"></div>
                    </div>
                </div>
            </div>
