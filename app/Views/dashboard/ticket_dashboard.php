...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="analytics">
            <div class="main-title pb-5">Ticket <img class="float-right" src="<?=$template?>assets/img/bismALLAH-hotel.png"> </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                2,512</h4>
                                                            <div class="status-det">Not Travel</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                456</h4>
                                                            <div class="status-det">Uncomplete Travel</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3 mt-lg-4 mt-md-4 mt-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                951</h4>
                                                            <div class="status-det">Expire</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-3 mt-lg-4 mt-md-4 mt-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-10 col-10 p-lg-0">
                                                            <h4 class="fs-18 hotel-rating text-black mb-0 font-w600">
                                                                157</h4>
                                                            <div class="status-det">Complete Travel</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row mt-5">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="hotel-sal-count p-4">
                        <div class="title">International Ticket Issue</div>
                        <div class="price text-center">156</div>
                        <div class="yellow-box"></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Domestic Ticket Issue</div>
                        <div class="price text-center">566</div>
                        <div class="red-box"></div>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Late Issue</div>
                        <div class="price text-center">566</div>
                        <div class="red-box"></div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Tommorow Flight</div>
                        <div class="price text-center">156</div>
                        <div class="yellow-box"></div>
                    </div>
                </div>
            ...
            <div class="row card-group-row mt-5 mb-5">
                <div class="col-lg-8 col-md-8 col-12 card-group-row__col">
                    <div class="card card-group-row__card hotel-sal-count">
                        <div class="row p-4">
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="title">Airline Wise Sale Graph</div>
                            </div>
                        </div>
                        <div class="card-body d-block align-items-center" style="height: 250px;">
                             <div class="chart w-100" style="height: calc(250px - 1.25rem * 2);">
                                <canvas id="AirlineWiseChart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12 mt-lg-0 mt-md-0 mt-5">
                    <div class="card card-group-row__card hotel-sal-count">
                        <div class="row p-4">
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="title">Target Base Airline Wise Sale</div>
                            </div>
                        </div>
                        <div class="card-body d-block align-items-center" style="height: 250px;">
                             <div class="chart w-100" style="height: calc(250px - 1.25rem * 2);">
                                <canvas id="TargetBaseAirline"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row card-group-row mt-5 mb-5">
                <div class="col-lg-6 col-md-6 col-12 card-group-row__col">
                    <div class="card for-height card-group-row__card hotel-sal-count">
                        ...
                        <div class="card-body d-block align-items-center" style="height: 250px;">
                             <div class="chart w-100" style="height: calc(250px - 1.25rem * 2);">
                                <canvas id="SaleMonthWise"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12 mt-lg-0 mt-md-0 mt-5">
                    <div class="p-2 for-height hotel-sal-count">
                        <div class="card">
                            <div class="row p-4">
                                <div class="col-lg-8 col-md-8 col-6">
                                    <div class="title">Sale Year Wise</div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-6">
                                    <select class="select-count p-1 w-100">
