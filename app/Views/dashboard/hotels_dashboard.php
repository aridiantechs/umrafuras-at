...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="analytics">
            <div class="main-title pb-5">Hotel <img class="float-right" src="<?=$template?>assets/img/bismALLAH-hotel.png"> </div>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6 col-md-12 col-12 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Cancel / Refund Booking</div>
                        <div class="price text-center">156 / 205</div>
            ...
            <div class="row mt-5">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Changed Booking</div>
                ...
                <div class="col-lg-3 col-md-6 col-6 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Tomorrow Check In</div>
                        <div class="price text-center">566</div>
                        <div class="red-box"></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6 mt-lg-0 mt-md-5 mt-5">
                    <div class="hotel-sal-count p-4">
                        <div class="title">Tomorrow Check Out</div>
                        <div class="price text-center">566</div>
                        <div class="green-box"></div>
                    </div>
                </div>
