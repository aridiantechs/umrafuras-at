...
//$CroneModel->GetPilgrimByActivityStatus();
//$TotalArrival = $CroneModel->TotalArrivals();
//$TotalExit = $CroneModel->TotalExit();


/*$CroneModel->UpdateCronActivity('GetPilgrimByActivityStatus');
$TotalArrival = $CroneModel->UpdateCronActivity('TotalArrivals');
$TotalExit = $CroneModel->UpdateCronActivity('TotalExit');


$DashboardCounters['total-arrival'] = ((isset($TotalArrival) && $TotalArrival != '') ? $TotalArrival : 0);
$DashboardCounters['total-exit'] = ((isset($TotalExit) && $TotalExit != '') ? $TotalExit : 0);*/
?>
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 layout-spacing">
                <h4>Welcome "<?= $session['name'] ?>" as <?= $user_types[$session['type']] ?> Account (E-Agent
                    Dashboard)</h4>
            </div>
...
<script type="application/javascript">
    ...
    function LoadPilgrimsChat() {
        ...
        var result = AjaxResponse("dashboard_ajax/agent_pilgrims_chat");
    ...
    function loadAgentsChart() {
        ...
        result = AjaxResponse("dashboard_ajax/agent_monthly_pilgrims_chart");
