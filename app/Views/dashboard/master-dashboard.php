                    ...
                    <div class="widget-content">
                        ...
                        <div class="header">
                            <div class="header-body">
                                <h6>Monthly Pilgrims Company Wise</h6>
                        ...
                        <div class="w-content">
                            <div class="">
                                <div class="task-left" id="TodayStatsEntered">
                                    <?= ((isset($DashboardCounters['jeddah-arrival'])) ? $DashboardCounters['jeddah-arrival'] : '-') ?>
                                </div>
                            </div>
                        </div>
                        <hr class="text-white">
                        ...
                        <div class="w-content">
                            <div class="">
                                <div class="task-left" id="TodayStatsExit">
                                    <?= ((isset($DashboardCounters['departure-jeddah'])) ? $DashboardCounters['departure-jeddah'] : '-') ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <div class="widget widget-card-four">
                    <div class="widget-content">
                        <div class="w-content">
                            <div class="w-info">
                                <h6 class="value"><?= ((isset($DashboardCounters['total_b2b_agent'])) ? $DashboardCounters['total_b2b_agent'] : '-') ?></h6>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <div class="widget widget-card-four">
                    <div class="widget-content">
                        <div class="w-content">
                            <div class="w-info">
                                <h6 class="value"><?= ((isset($DashboardCounters['external_agents'])) ? $DashboardCounters['external_agents'] : '-') ?></h6>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <div class="widget widget-card-four">
                    <div class="widget-content">
                        <div class="w-content">
                            <div class="w-info">
                                <h6 class="value"><?= ((isset($DashboardCounters['total_active_b2b_agent'])) ? $DashboardCounters['total_active_b2b_agent'] : '-') ?></h6>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <div class="widget widget-card-four">
                    <div class="widget-content">
                        <div class="w-content">
                            <div class="w-info">
                                <h6 class="value"><?= ((isset($DashboardCounters['total_inactive_b2b_agent'])) ? $DashboardCounters['total_inactive_b2b_agent'] : '-') ?></h6>
                            ...
                            <div id="GroupStatsRecords">
                                ...
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <p>
                                                <span><?= ((isset($DashboardCounters['jeddah-arrival'])) ? $DashboardCounters['jeddah-arrival'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <p>
                                                <span><?= ((isset($DashboardCounters['medina-arrival'])) ? $DashboardCounters['medina-arrival'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <p>
                                                <span><?= ((isset($DashboardCounters['yanbu-arrival'])) ? $DashboardCounters['yanbu-arrival'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <p>
                                                <span><?= ((isset($DashboardCounters['sea-arrival'])) ? $DashboardCounters['sea-arrival'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <p>
                                                <span><?= ((isset($DashboardCounters['by-road-arrival'])) ? $DashboardCounters['by-road-arrival'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <p>
                                                <?php
                                                $TotalArrival = $DashboardCounters['jeddah-arrival'] + $DashboardCounters['medina-arrival'] + $DashboardCounters['sea-arrival'] + $DashboardCounters['yanbu-arrival'] + $DashboardCounters['by-road-arrival'];
                            ...
                            <div id="TransactionStatsRecords">
                                ...
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <span><?= ((isset($DashboardCounters['check-in-mecca'])) ? $DashboardCounters['check-in-mecca'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <span><?= ((isset($DashboardCounters['check-in-medina'])) ? $DashboardCounters['check-in-medina'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <span><?= ((isset($DashboardCounters['check-in-jeddah'])) ? $DashboardCounters['check-in-jeddah'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <span><?= ((isset($DashboardCounters['check-out-mecca'])) ? $DashboardCounters['check-in-mecca'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <span><?= ((isset($DashboardCounters['check-out-medina'])) ? $DashboardCounters['check-in-medina'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transactions-list">
                                    <div class="t-item">
                                        ...
                                        <div class="t-rate rate-inc">
                                            <span><?= ((isset($DashboardCounters['check-out-jeddah'])) ? $DashboardCounters['check-in-jeddah'] : '-') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
<script type="application/javascript">
    ...
    function LoadPilgrimsChat() {
        ...
        result = AjaxResponse("dashboard_ajax/pilgrims_chat");
