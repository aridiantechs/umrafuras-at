    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Un Assign Packages
<!--                    --><?php //if ($CheckAccess['umrah_services_packages_un_assign_copy']) { ?>
...
//                                if ($CheckAccess['umrah_services_packages_un_assign_Update']) {
//                                    if ($session['id'] != $record['AgentUID']) {
//                                        $actions .= '<a class="dropdown-item" href="' . $path . 'package/update_package/' . $record['UID'] . '" > Update</a >';
//                                    }
//                                }
                                if ($CheckAccess['umrah_services_packages_un_assign_download']) {
                                    $actions .= '<a class="dropdown-item"  href="' . SeoUrl('exports/unassign_b2b_package/' . $record['UID'] . "-" . $record['Name']) . '" target="_blank"> Download</a >';
                                }
                                $actions .= '</div>';
...
//                                </div>';
                                ...
                                if ($CheckAccess[''] || $CheckAccess['umrah_services_packages_un_assign_download']) {
                                    echo ' 
                                    <td>
                                        <div class="btn-group">
                                            <button type="button"
...
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_services_packages_un_assign_export']) { ?>
    setTimeout(function () {
        $('<a target="_blank" href="<?=$path?>exports/ListUnAssignPackages" class="dt-filter-btn">Export</a>').appendTo(".dataTables_wrapper .dataTables_filter");
    }, 100);
    <?php } ?>
</script>