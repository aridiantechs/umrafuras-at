        ...
        <div class="row layout-spacing">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <form class="section contact validate" method="post" action="#" id="B2CPackageUpdateForm"
                          name="B2CPackageUpdateForm">
...
<!--                                                    </div>-->
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                        <div class="" id="b2cPackageUpdateResponse"></div>
                    </div>
                </div>
            </div>
...
<script type="application/javascript">
    ...
    $("form#B2CPackageUpdateForm").on("submit", function (event) {
        event.preventDefault();
    });

    function PackageFormSubmit() {

        var validate = $("form#B2CPackageUpdateForm").validationEngine('validate');
        if (validate == false) {
            return false;
        }

        var phpdata = new window.FormData($("form#B2CPackageUpdateForm")[0]);
        response = AjaxUploadResponse("form_process/b2c_package_form_submit", phpdata);

        if (response.status == 'success') {
            $("#b2cPackageUpdateResponse").html('<div class="alert alert-success mb-4" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x close" data-dismiss="alert"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button> <strong>Success!</strong> ' + response.message + ' </div>')
            setTimeout(function () {
                location.href = "<?=base_url('package/b2c_package')?>";
            }, 2000)
        } else {
