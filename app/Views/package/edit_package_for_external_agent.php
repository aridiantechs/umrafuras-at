...
<!--                                                    </div>-->
                                                    ...
                                                    foreach ($data['LookupsOptions'] as $options) {
                                                        ...
                                                        <input type="number" class="form-control mb-4 validate[required]" id="VisaCharges" name="VisaCharges[' . $options['UID'] . ']" placeholder="' . $options['Name'] . ' Visa" value="' . $PackageMetaData['Value'] . '"></div>
                                                                </div>';
                                                    }
                                                    ?>
