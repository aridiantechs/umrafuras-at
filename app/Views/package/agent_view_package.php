                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="MainRecords" class="table table-hover non-hover display nowrap">
                                                            ...
                                                            foreach ($HotelsData as $HotelUID => $thisData) {
                                                                list($HotelUID, $CityUID) = explode("|", $HotelUID);
                                                                ?>
                                                            <tr id="TR<?= $i ?>">
                                                                <td>
...
<script type="application/javascript">
    ...
    function DefaultHotelRowHTML(cnt) {
        ...
        HotelCities = '<select class="form-control HotelCities" id="City_' + cnt + '" name="City[]" onChange="LoadHotelByCites(this.value, ' + cnt + ')" ><option value="">Please Select</option>' + cities.html + '</select>'
