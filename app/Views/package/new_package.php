                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mx-auto">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group"> <label for="visa charges">' . $options['Name'] . ' Rate</label> <input type="text" class="form-control mb-4" id="VisaCharges" name="VisaCharges[' . $options['UID'] . ']" placeholder="' . $options['Name'] . ' Visa"></div>
                                                                </div>';
                                                    }
                                                    ?>
                                                </div>
                                                    ...
                                                    <table id="MainRecords"
                                                        ...
                                                        for ($i = 0; $i < count($TransportSectors); $i++) {
                                                            ...
                                                            foreach ($TransportData as $TransportUID => $thisType) {
                                                                echo '<td><input class="form-control transportclass" type="text" name="TransportRate[' . $TransportUID . "|" . $Sector . "|" . $i . ']"></td>';
                                                            }
                                                            echo '</tr>';
                                                        }
                                                        ?>
...
<script type="application/javascript">
    ...
    function PackageFormSubmit() {
        ...
        response = AjaxUploadResponse("form_process/package_form_submit", phpdata);
...
<script>
    ...
    function PackageValidation(currentIndex, newIndex) {
        if (newIndex < currentIndex) {
            $("form#PackageAddForm").validationEngine('hideAll');
            return true;
        }
        var validate = $("form#PackageAddForm").validationEngine('validate');
        if (validate == false) {
