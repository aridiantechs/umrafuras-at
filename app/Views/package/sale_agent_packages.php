    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Sale Agent Package
                    <?php
                    $Crud = new Crud();
                    $Page = getSegment(2);
                    ...
                    if (count($records) > 0) { echo '  <a class="btn btn_customized btn-sm float-right" href="#" onclick="LoadModal(\'package/package_approval_modal.php\', 0)">Approve Package</a>'; }
                    else {  echo '   <a class="btn btn_customized btn-sm float-right" href="' . $path . 'package/new_package">Add New</a>'; }
                    ?>
                        ...
                        <table id="MainRecords" class="table table-hover non-hover display nowrap" style="width:100%">
                            ...
                            foreach ($packages as $record) {
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                    <a class="dropdown-item" href="' . SeoUrl('exports/b2b_package/' . $record['UID'] . "-" . $record['Name']) . '" target="_blank">Download</a>
                                </div>';
                                echo '
                                <tr>
                                    <td>' . $cnt . '</td>
