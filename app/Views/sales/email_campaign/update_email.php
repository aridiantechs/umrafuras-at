    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <h4 class="page-head">Update Email </h4>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <form class="section contact" method="" action="" id="AddEmail">
                    <input type="hidden" name="Old_Email" value="<?= $FinalArray['Email'] ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?= $FinalArray['FullName'] ?>"
                                                               class="form-control  validate[required]" id="Name"
                                                ...
                                                <div class="form-group mb-4" id="">
                                                    ...
                                                    <div class="n-chk row mt-3">
                                                        <?php foreach ($EmailLists as $value) {
                                                            if (in_array( $value['UID'] , $FinalArray['EmailListIDs'] ))
                                                            { $checked = 'checked'; }
                                                            else { $checked = ''; }
                                                            echo '<label class=" new-control new-checkbox checkbox-primary">
                                                                     <input id="' . $value['UID'] . '" type="checkbox"
                                                                       class=""
                                                                       value="1" name="group[' . $value['UID'] . ']"  '.$checked.'  style="margin-right: 7px;"  >
                                                                        <span class=""></span><strong>' . ucwords($value['FullName']) . ' </strong>
                                                                  </label>';
                                                        } ?>
                                                    </div>
...
<script type="application/javascript">
    ...
    function SaveAddEmailForm() {
        ...
        if (response.status == 'success') {
            ...
            window.location.href = '<?= $path ?>emailcampaign/view_all_email_ids';
