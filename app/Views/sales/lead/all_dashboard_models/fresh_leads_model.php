...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Fresh Leads</h5>
                ...
                <table style="margin-bottom: 0px !important;" class="table table-bordered table-striped">
                    ...
                    foreach ($profile as $value) {
                        ...
                        <tr>
                            ...
                            <td><?php if ($value['CallBackDateTime'] != NULL && $value['CallBackDateTime'] != '') {
                                    echo date("d M, Y h:i A", strtotime($value['CallBackDateTime']));
                                } else {
                                    echo "-";
                                } ?></td>
                            ...
                            <td>
                                <badge class="badge badge-success"><?= ucwords(str_replace('_', ' ', $value['Status'])) ?></badge>
                            </td>
