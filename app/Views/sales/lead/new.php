...
$Crud = new Crud();
$session = session();
$SessionFilters = $session->get('NewLeadsSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head"><b style="color:darkgoldenrod !important;">"<?= ucwords($product_name) ?>"</b> New
                    Leads
                ...
                <div id="toggleAccordion">
                    <div class="card">
                        ...
                        <div id="FilterDetails" class="collapse show " aria-labelledby=""
                            ...
                            <div class="card-body">
                                <form method="post"
                                      onsubmit="NewLeadsFiltersFormSubmit( 'NewLeadsSearchFilterForm' ); return false;"
                                      class="section contact" name="NewLeadsSearchFilterForm"
                                      id="NewLeadsSearchFilterForm">
                                    <input type="hidden" name="SessionKey" id="SessionKey"
                                           value="NewLeadsSessionFilters">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="NewLeadsFiltersFormSubmit( 'NewLeadsSearchFilterForm' );"
                                                        id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('NewLeadsSessionFilters');"
                                                        id="btnreset" type="button" class="btn btn-danger">Clear
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-md-12" id="NewLeadFilterAjaxResult"></div>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="LeadsRecord" class="table table-hover non-hover display nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            if (CreateStartDate != '' && CreateEndDate != '') {
                ...
                $("form#NewLeadsSearchFilterForm input#create_start_date").val('');
                $("form#NewLeadsSearchFilterForm input#create_end_date").val('');
            }
            ...
            if (DistributionStartDate != '' && DistributionEndDate != '') {
                ...
                $("form#NewLeadsSearchFilterForm input#distribution_start_date").val('');
                $("form#NewLeadsSearchFilterForm input#distribution_end_date").val('');
            }
        }, 1000);

        var Product = '<?= $product_name ?>';
        $('#LeadsRecord').DataTable({
            "searching": false,
            "processing": true,
            "pageLength": 100,
            "serverSide": true,
            ...
            "ajax":
                {
                    url: "<?= $path ?>lead/get_new_product_data",
                    type: 'POST',
    ...
    function NewLeadsFiltersFormSubmit(parent) {

        var dataTable = $('#LeadsRecord').DataTable();
        var data = $("form#" + parent).serialize();
        var rslt = AjaxResponse('filters_session/create_filters_session', data);
        if (rslt.status == 'success') {
            GridMessages(parent, 'NewLeadFilterAjaxResult', 'alert-success', rslt.msg, 1500);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('NewLeadsSearchFilterForm', 'NewLeadFilterAjaxResult', 'alert-success', rslt.msg, 1500);
            $("form#NewLeadsSearchFilterForm input#create_start_date").val('');
            $("form#NewLeadsSearchFilterForm input#create_end_date").val('');
            $("form#NewLeadsSearchFilterForm input#distribution_start_date").val('');
            $("form#NewLeadsSearchFilterForm input#distribution_end_date").val('');
            $("form#NewLeadsSearchFilterForm")[0].reset();
            setTimeout(function () {
                dataTable.ajax.reload();
            }, 2000);
        }
