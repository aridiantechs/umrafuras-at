...
<!--                    <li --><?//= (($module == "agent" && $page == "index") ? ' class="active" ' : '') ?><!--
                       <a href="--><?//= $path ?><!--agent/index">List </a>-->
<!--                    </li>-->
            ...
            <li class="menu <?= (($module == 'group' && $page == 'index') ? 'active' : '') ?> ">
                ...
                <ul class="collapse submenu list-unstyled" id="groups" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="#groups-error" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Pilgrim
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-chevron-right">
           ...
           <?php
           if ($CheckAccess['navigation_new_voucher'] || $CheckAccess['navigation_updated_voucher']) {
               ?>
               <li class="menu">
                   ...
                   <ul class="collapse submenu list-unstyled"
                       ...
                       if ($CheckAccess['navigation_new_voucher']) { ?>
                           <li>
                               <a href="<?= $path ?>agent/vouchers">New Voucher</a>
                           </li>
                           <?php
                       }
           ...
           ?>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="package" data-parent="#accordionExample">
                    <li>
                        <a href="#hotel" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Hotel
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-chevron-right">
                                <polyline points="9 18 15 12 9 6"></polyline>
                    ...
                    <li>
                        <a href="#transport" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Transport
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-chevron-right">
                    ...
                    <li>
                        <a href="#ziarat" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Ziyarat
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-chevron-right">
                                <polyline points="9 18 15 12 9 6"></polyline>
