<?php if ($CheckAccess['sales_dashboard']) { ?>
    <li class="menu">
        <a href="#dashboard" class="dropdown-toggle" data-toggle="collapse" aria-expanded="false">
            <div class="">
        ...
        <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#accordionExample">
            <li>
                <!--                    <a href="--><? //= $path ?><!--home/sales?nav=sales" aria-expanded="false"-->
                <a href="<?= $path ?>home/sales" aria-expanded="false"
                   target="">All
                </a>
            </li>
            <li>
                <a href="<?= $path ?>home/b2bsalesdashboard" aria-expanded="false"
                   target="">B2B
                </a>
            </li>
            <li>
                <a href="<?= $path ?>home/b2csalesdashboard" aria-expanded="false"
                   target="">B2C
                </a>
            </li>
        </ul>
                        ...
                        <ul class="collapse list-unstyled sub-submenu" id="<?= $value ?>" data-parent="">
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="callback" data-parent="">
                                    <li>
                                        <a href="<?= $path ?>lead/callback/current_month/<?= $value ?>" target="_blank">Current
                                            Month</a>
                                    </li>
                                    <li>
                                        <a href="<?= $path ?>lead/callback/previous_month/<?= $value ?>"
                                           target="_blank">Previous Month</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
<li class="menu">
    ...
    <ul id="reports" class="collapse submenu list-unstyled" data-parent="">
        ...
        <li>
            <a href="<?= $path ?>reports/organic_activities_stats">Organic Activities Stats </a>
        </li>
        <li>
            <a href="<?= $path ?>reports/agent_leads_distribution">Agent Leads Distribution </a>
        </li>
        <li>
            <a href="<?= $path ?>reports/daily_leads_distribution">Leads Status Distribution </a>
        </li>
        <li>
