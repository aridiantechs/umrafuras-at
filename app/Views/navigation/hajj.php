...
<?php
if ($CheckAccess['hajj_dashboard']) { ?>

    <li class="menu">
        <a href="<?= $path ?>home/hajj" class="dropdown-toggle" aria-expanded="false">
            <div class="">
...
<?php
if ($CheckAccess['hajj_client'] || $CheckAccess['hajj_client_b2c'] || $CheckAccess['hajj_client_b2b'] || $CheckAccess['hajj_client_sale_agents'] || $CheckAccess['hajj_client_external_agent']) { ?>
    <li class="menu <?= (($module == 'agent' && $page == 'index') ? 'active' : '') ?>">
        ...
        <ul class="collapse submenu list-unstyled" id="agents" data-parent="#accordionExample">
            <?php
            if ($CheckAccess['hajj_client_b2c']) { ?>
                <li>
                    <a href="<?= $path ?>agent/B2C">B2C</a>
                </li>
            <?php }
            if ($CheckAccess['hajj_client_b2b']) { ?>
                <li <?= (($module == "agent" && $page == "index") ? ' class="active" ' : '') ?>>
                    <a href="<?= $path ?>agent/index">B2B </a>
                </li>
            <?php }
            if ($CheckAccess['hajj_client_sale_agents']) {
                ?>
                <li>
                    <a href="<?= $path ?>sale_agents/index">Sale Agent</a>
                </li> <?php
            }
            if ($CheckAccess['hajj_client_external_agent'] || $CheckAccess['hajj_client_external_agent_list'] || $CheckAccess['hajj_client_external_agent_sub_agents']) { ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled sub-submenu" id="groups-error" data-parent="#groups">
                        <?php
                        if ($CheckAccess['hajj_client_external_agent_list']) {
                            ?>
                            <li <?= (($module == "user" && $page == "external_agent") ? ' class="active" ' : '') ?>>
                                <a href="<?= $path ?>user/external_agent">List</a>
                            </li> <?php
                        }
                        if ($CheckAccess['hajj_client_external_agent_sub_agents']) { ?>
...
if ($CheckAccess['hajj_travel_check'] || $CheckAccess['hajj_travel_check_create_voucher'] || $CheckAccess['hajj_travel_check_all_voucher'] || $CheckAccess['hajj_travel_check_pending_voucher'] || $CheckAccess['hajj_travel_check_approved_voucher'] || $CheckAccess['hajj_travel_check_updated_voucher'] || $CheckAccess['hajj_travel_check_executed_voucher'] || $CheckAccess['hajj_travel_check_refund_voucher'] || $CheckAccess['hajj_travel_check_wdout_voucher_arrival']) {
    ?>
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled"
            ...
            <?php
            if ($CheckAccess['hajj_travel_check_create_voucher']) { ?>
                <li>
                    <a href="<?= $path ?>agent/voucher">Create Voucher</a>
                </li>
                <?php
            }
            if ($CheckAccess['hajj_travel_check_all_voucher']) { ?>
                <li>
                <a href="<?= $path ?>agent/all_voucher">All Voucher</a>
                </li><?php
            }
            if ($CheckAccess['hajj_travel_check_pending_voucher']) { ?>
                <li>
                <a href="<?= $path ?>agent/pending_voucher">Pending Voucher</a>
                </li><?php
            }
            if ($CheckAccess['hajj_travel_check_approved_voucher']) { ?>
                <li>
                <a href="<?= $path ?>agent/approved_voucher">Approved Vouchers</a>
                </li><?php
            }
            if ($CheckAccess['hajj_travel_check_updated_voucher']) { ?>
                <li>
                <a href="<?= $path ?>agent/updated_vouchers">Updated Voucher</a>
                </li><?php
            }
            if ($CheckAccess['hajj_travel_check_executed_voucher']) { ?>
                <li>
                <a href="<?= $path ?>agent/all_executed_voucher">Executed Vouchers</a>
                </li><?php
            }
            if ($CheckAccess['hajj_travel_check_refund_voucher']) { ?>
                <li>
                <a href="<?= $path ?>agent/refund_vouchers">Refund Voucher</a>
                </li><?php
            }
            if ($CheckAccess['hajj_travel_check_wdout_voucher_arrival']) { ?>
                <li>
...
if ($CheckAccess['hajj_activity'] || $CheckAccess['hajj_activity_allow_pilgrim_activity'] ||
    $CheckAccess['hajj_activity_actual_pilgrim_activity'] || $CheckAccess['hajj_activity_passport_management'] || $CheckAccess['hajj_activity_visa_management']) { ?>
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="activity" data-parent="#accordionExample">
            <?php
            if ($CheckAccess['hajj_activity_allow_pilgrim_activity'] || $CheckAccess['hajj_activity_allow_pilgrim_activity_allow_hotel_activities'] || $CheckAccess['hajj_activity_allow_pilgrim_activity_allow_transport_activities']) { ?>
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="allow_pilgrim"
                        ...
                        <?php
                        if ($CheckAccess['hajj_activity_allow_pilgrim_activity_allow_hotel_activities']) { ?>
                            <li>
                            <a href="<?= $path ?>pilgrim/allow_hotel_activities">Allow Hotel Activities</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_activity_allow_pilgrim_activity_allow_transport_activities']) {
                            ?>
                            <li>
            ...
            if ($CheckAccess['hajj_activity_actual_pilgrim_activity'] || $CheckAccess['hajj_activity_actual_pilgrim_activity_actual_hotel_activities'] || $CheckAccess['hajj_activity_actual_pilgrim_activity_actual_transport_activities']) { ?>
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="actual_pilgrim"
                        ...
                        <?php
                        if ($CheckAccess['hajj_activity_actual_pilgrim_activity_actual_hotel_activities']) { ?>
                            <li>
                            <a href="<?= $path ?>pilgrim/actual_hotel_activities">Actual Hotel
                                Activities</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_activity_actual_pilgrim_activity_actual_transport_activities']) {
                            ?>
                            <li>
            ...
            if ($CheckAccess['hajj_activity_passport_management'] || $CheckAccess['hajj_activity_passport_management_passport_pending'] || $CheckAccess['hajj_activity_passport_management_passport_completed']) { ?>
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="passport" data-parent="#passport">
                        <?php
                        if ($CheckAccess['hajj_activity_passport_management_passport_pending']) { ?>
                            <li>
                            <a href="<?= $path ?>pilgrim/pending_passports">Pending</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_activity_passport_management_passport_completed']) {
                            ?>
                            <li>
            ...
            if ($CheckAccess['hajj_activity_visa_management'] || $CheckAccess['hajj_activity_visa_management_manage_visa'] || $CheckAccess['hajj_activity_visa_management_manage_mofa']) { ?>
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="visa-manage" data-parent="#visa-manage">
                        <?php
                        if ($CheckAccess['hajj_activity_visa_management_manage_visa']) {
                            ?>
                        <li <?= (($module == "user" && $page == "visa_details") ? ' class="active" ' : '') ?>>
                            <a href="<?= $path ?>mofa/visa_details"> Manage Visa</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_activity_visa_management_manage_mofa']) { ?>
...
if ($CheckAccess['hajj_data_uploader']) {
    ?>
    <li class="menu">
...
if ($CheckAccess['hajj_brn_management'] || $CheckAccess['hajj_brn_management_hotel_brn'] || $CheckAccess['hajj_brn_management_transport_brn'] || $CheckAccess['hajj_brn_management_promo_code']) {
    ?>
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="brn" data-parent="#accordionExample">
            ...
            <!--                            --><?php
            //                        }
            if ($CheckAccess['hajj_brn_management_hotel_brn']) { ?>
                <li>
                    <a href="<?= $path ?>brn/hotel_brn">Hotel BRN </a>
                </li>
                <?php
            }
            if ($CheckAccess['hajj_brn_management_transport_brn']) { ?>
                <li>
                    <a href="<?= $path ?>brn/transport_brn">Transport BRN</a>
                </li>
                <?php
            }
            if ($CheckAccess['hajj_brn_management_promo_code']) { ?>
                <li>
...
if ($CheckAccess['hajj_groups'] || $CheckAccess['hajj_groups_create_new'] || $CheckAccess['hajj_groups_manage'] || $CheckAccess['hajj_groups_deleted_groups'] || $CheckAccess['hajj_groups_pilgrim']) {
    ?>
    <li class="menu <?= (($module == 'group' && $page == 'index') ? 'active' : '') ?> ">
        ...
        <ul class="collapse submenu list-unstyled" id="groups" data-parent="#accordionExample">
            <?php
            if ($CheckAccess['hajj_groups_create_new']) { ?>
                <li <?= (($module == "group" && $page == "add_group") ? ' class="active" ' : '') ?>>
                    <a href="<?= $path ?>group/add_group">Create New Groups </a>
                </li>

                <?php
                if ($CheckAccess['hajj_groups_manage'] || $CheckAccess['hajj_groups_manage_incomplete'] || $CheckAccess['hajj_groups_manage_complete']) { ?>
                    <li>
                        <a href="#groups-error" data-toggle="collapse" aria-expanded="false"
                        ...
                        <ul class="collapse list-unstyled sub-submenu" id="groups-error" data-parent="#groups">
                            <?php
                            if ($CheckAccess['hajj_groups_manage_incomplete']) { ?>
                                <li>
                                    <a href="<?= $path ?>group/index/in-complete">In-Complete</a>
                                </li>  <?php } ?>
                            <?php
                            if ($CheckAccess['hajj_groups_manage_complete']) { ?>
                                <li>
            ...
            if ($CheckAccess['hajj_groups_deleted_groups']) { ?>
            <li <?= (($module == "group" && $page == "deleted_groups") ? ' class="active" ' : '') ?>>
                <a href="<?= $path ?>group/deleted_groups">Deleted Groups </a>
                </li><?php
            }
            if ($CheckAccess['hajj_groups_pilgrim'] || $CheckAccess['hajj_groups_pilgrim_list'] || $CheckAccess['hajj_groups_pilgrim_new_registration'] || $CheckAccess['hajj_groups_pilgrim_pilgrim_title_options'] || $CheckAccess['hajj_groups_pilgrim_transfer']) { ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled sub-submenu" id="pilgrim-error" data-parent="#groups">
                        <?php
                        if ($CheckAccess['hajj_groups_pilgrim_new_registration']) {
                            ?>
                            <li>
                            <a href="<?= $path ?>pilgrim/new">New Registration</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_groups_pilgrim_list']) { ?>
                            <li>
                        ...
                        if ($CheckAccess['hajj_groups_pilgrim_pilgrim_title_options']) {
                            ?>
                            <li>
                        ...
                        if ($CheckAccess['hajj_groups_pilgrim_transfer']) {
                            ?>
                            <li>
...
if ($CheckAccess['hajj_reports'] || $CheckAccess['hajj_reports_stats'] || $CheckAccess['hajj_reports_status_stats'] || $CheckAccess['hajj_reports_vendors']) {
    ?>
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="reports" data-parent="#accordionExample">
            ...
            <!--                            --><?php
            //                        }
            if ($CheckAccess['hajj_reports_stats']) { ?>
                <li>
                    <a href="<?= $path ?>reports/stats">Report Stats</a>
                </li>
                <?php
            } ?>
            <?php if ($CheckAccess['hajj_reports_status_stats']) { ?>
                <li>
                    <a href="<?= $path ?>home/stats">Status Stats</a>
                </li>
                <?php
            } ?>
            <?php if ($CheckAccess['hajj_reports_vendors']) { ?>
                <li>
                    <a href="<?= $path ?>reports/hajj_vendor">Vendors</a>
                </li>
                <?php
            } ?>
        </ul>
...
if ($CheckAccess['hajj_services'] || $CheckAccess['hajj_services_hotel'] || $CheckAccess['hajj_services_transport'] || $CheckAccess['hajj_services_ziyarat'] || $CheckAccess['hajj_services_packages'] || $CheckAccess['hajj_services_visa_type'] || $CheckAccess['hajj_services_extra_services'] || $CheckAccess['hajj_services_operator']) {
    ?>
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="package" data-parent="#accordionExample">
            <?php
            if ($CheckAccess['hajj_services_hotel'] || $CheckAccess['hajj_services_hotel_list'] || $CheckAccess['hajj_services_hotel_categories'] || $CheckAccess['hajj_services_hotel_facilities'] || $CheckAccess['hajj_services_hotel_amenities'] || $CheckAccess['hajj_services_hotel_room_types']) { ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled sub-submenu" id="hotel" data-parent="#package">
                        <?php
                        if ($CheckAccess['hajj_services_hotel_list']) { ?>
                            <li>
                            <a href="<?= $path ?>package/hotel">List</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_services_hotel_categories']) {
                            ?>
                            <li>
                            <a href="<?= $path ?>setting/lookup_options/hotel_category">Hotel Categories</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_services_hotel_facilities']) {
                            ?>
                            <li>
                        ...
                        if ($CheckAccess['hajj_services_hotel_amenities']) {
                            ?>
                            <li>
                            <a href="<?= $path ?>setting/lookup_options/hotel_amenities">Hotel Amenities</a>
                            </li><?php
                        }
                        if ($CheckAccess['hajj_services_hotel_room_types']) {
                            ?>
                            <li>
            ...
            <?php
            if ($CheckAccess['hajj_services_transport'] || $CheckAccess['hajj_services_transport_list'] || $CheckAccess['hajj_services_transport_type'] || $CheckAccess['hajj_services_transport_sectors'] || $CheckAccess['hajj_services_transport_borders'] || $CheckAccess['hajj_services_transport_sea_ports'] || $CheckAccess['hajj_services_transport_companies']) {
                ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled sub-submenu" id="transport" data-parent="#package">
                        <?php
                        if ($CheckAccess['hajj_services_transport_list']) { ?>
                            <li>
                                <a href="<?= $path ?>package/transport">List</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_transport_type']) { ?>
                            <li>
                                <a href="<?= $path ?>setting/lookup_options/transport_types">Transport
                                    Types</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_transport_sectors']) { ?>
                            <li>
                                <a href="<?= $path ?>setting/lookup_options/transport_sectors">Transport
                                    Sectors</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_transport_borders']) { ?>
                            <li>
                                <a href="<?= $path ?>setting/lookup_options/land_borders">Borders</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_transport_sea_ports']) { ?>
                            <li>
                                <a href="<?= $path ?>setting/lookup_options/sea_ports">Sea Ports</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_transport_companies']) { ?>
                            <li>
            ...
            <?php } ?>
            <?php
            if ($CheckAccess['hajj_services_ziyarat']) {
                ?>
                <li>
            ...
            if ($CheckAccess['hajj_services_packages'] || $CheckAccess['hajj_services_packages_b2b_external'] || $CheckAccess['hajj_services_packages_b2b'] || $CheckAccess['hajj_services_packages_B2b_general'] || $CheckAccess['hajj_services_packages_b2c']) { ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled sub-submenu" id="packages" data-parent="#package">
                        <?php
                        if ($CheckAccess['hajj_services_packages_b2b_external']) { ?>
                            <li>
                                <a href="<?= $path ?>package/b2b_external_package">B2B External</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_packages_b2b']) { ?>
                            <li>
                                <a href="<?= $path ?>package/b2b_packages">B2B</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_packages_B2b_general']) { ?>
                            <li>
                                <a href="<?= $path ?>package/b2b_general_package">B2B General</a>
                            </li>
                        <?php }
                        if ($CheckAccess['hajj_services_packages_b2c']) { ?>
                            <li>
            ...
            if ($CheckAccess['hajj_services_visa_type']) {
                ?>
                <li>
                <a href="<?= $path ?>setting/lookup_options/visa_types">Visa Types</a>
                </li><?php
            }
            if ($CheckAccess['hajj_services_extra_services']) {
                ?>
                <li>
            ...
            <?php }
            if ($CheckAccess['hajj_services_operator']) {
                ?>
                <li>
...
<?php
if ($CheckAccess['hajj_users'] || $CheckAccess['hajj_users_system_user'] || $CheckAccess['hajj_users_access_level']) {
    ?>
    ...
    <li class="menu <?= (($module == 'user' && in_array($page, $options)) ? 'active' : '') ?>">
        ...
        <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
            <?php
            if ($CheckAccess['hajj_users_system_user']) { ?>
                <li <?= (($module == "user" && $page == "index") ? ' class="active" ' : '') ?>>
                    <a href="<?= $path ?>user/index">System Users </a>
                </li>
                <?php
            }
            if ($CheckAccess['hajj_users_access_level']) {
                ?>
                <li>
...
<?php
if ($CheckAccess['hajj_settings'] || $CheckAccess['hajj_settings_mis'] || $CheckAccess['hajj_settings_websites'] || $CheckAccess['hajj_settings_activity_log'] || $CheckAccess['hajj_settings_database_backup'] || $CheckAccess['hajj_settings_agent_types'] || $CheckAccess['hajj_settings_multi_languages']) {
    ?>
    ...
    <li class="menu <?= (($module == 'setting' && (in_array($page, $options))) ? 'active' : '') ?>">
        ...
        <ul class="collapse submenu list-unstyled " id="settings" data-parent="#accordionExample">
            <?php if ($session['domain_parent'] > 0) { ?>
                ...
                <?php
                if ($CheckAccess['hajj_settings_mis']) { ?>
            ...
            ?>
            <?php
            if ($CheckAccess['hajj_settings_websites']) {
            ...
            <?php
            if ($CheckAccess['hajj_settings_activity_log']) {
                ?>
                <li <?= (($module == "setting" && $page == "activity_log") ? ' class="active" ' : '') ?>>
            ...
            <?php
            if ($CheckAccess['hajj_settings_database_backup']) {
                ?>
            ...
            <?php
            if ($CheckAccess['hajj_settings_agent_types']) {
                ?>
                <li>
                <a href="<?= $path ?>setting/lookup_options/agent_types">Agent Types</a>
                </li><?php
            }
            if ($CheckAccess['hajj_settings_multi_languages'] || $CheckAccess['hajj_settings_multi_languages_languages'] || $CheckAccess['hajj_settings_multi_languages_translation']) {
                ?>
                <li>
                ...
                <ul class="collapse list-unstyled sub-submenu" id="settings-error" data-parent="#settings">
                    ...
                    <?php
                    if ($CheckAccess['hajj_settings_multi_languages_languages']) {
                        ?>
                        <li>
                    ...
                    <?php
                    if ($CheckAccess['hajj_settings_multi_languages_translation']) {
                        ?>
                        <li>
