    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="<?= $path ?>" class="dropdown-toggle" aria-expanded="false">
                        <div class="">
                            ...
                            <span>Dashboard</span> <? /*= $session['domainid'] */ ?>
                        </div>
                    </a>
                </li>
            <?php } ?>
            <?php
            if ($CheckAccess['umrah_client_b2c_list'] || $CheckAccess['umrah_client_b2b_list'] || $CheckAccess['umrah_client_sale_agents_list'] || $CheckAccess['umrah_client_external_agent_list']) { ?>
            ...
            if ($CheckAccess['umrah_activity_allow_pilgrim_activity'] || $CheckAccess['umrah_activity_actual_pilgrim_activity'] ||
                $CheckAccess['umrah_activity_passport_management'] || $CheckAccess['umrah_activity_visa_management']) { ?>
                <li class="menu">
            ...
            if ($CheckAccess['umrah_groups_create_new'] ||  $CheckAccess['umrah_groups_manage_complete_list'] || $CheckAccess['umrah_groups_manage_incomplete_list']) {
                ?>
            ...
            if ($CheckAccess['umrah_services_hotel'] || $CheckAccess['umrah_services_transport'] || $CheckAccess['umrah_services_ziyarat_list'] || $CheckAccess['umrah_services_packages'] || $CheckAccess['umrah_services_visa_type'] || $CheckAccess['umrah_services_extra_services'] || $CheckAccess['umrah_services_operator_list']) {
                ?>
                <li class="menu">
