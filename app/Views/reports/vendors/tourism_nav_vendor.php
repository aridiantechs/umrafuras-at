                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_confirm_booking" target="_blank">
                                                Read
                                                More</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_change_booking" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            Refund</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_refund_booking" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Detail
                                            Report</h6>
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_detail_report" target="_blank">
                                                Read
                                                More</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Country
                                            Wise</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_country_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Package
                                            Category Wise</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_package_category_wise"
                                               target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Month
                                            Wise</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_month_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Year
                                            Wise</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>vendor_reports/tour_year_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
