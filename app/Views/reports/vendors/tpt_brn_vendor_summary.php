    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">
                    Transport BRN Vendor Summary
                    <?php if ($CheckAccess['umrah_reports_vendors_summary_tpt_brn_vendor_summary_export']) { ?>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="ReportTable" class="table table-hover non-hover display nowrap cell-border" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th rowspan="2">Vendor City</th>
                                <th rowspan="2">TPT Company</th>
                                <th rowspan="2">No of BRN</th>
                                <th colspan="2" style="text-align: center">Visa</th>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Transport BRN Vendor Summary",
                "info": "Showing _START_ to _END_ of _TOTAL_ Transport BRN Vendor Summary",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_all_transport_brn_vendor_summary_report",
                type: "POST",
                data: function (data) {
