    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">
                    TPT Vendor Summary
                    <?php if ($CheckAccess['umrah_reports_vendors_summary_tpt_vendor_summary_export']) { ?>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Transport Vendor Summary Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Transport Vendor Summary Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_all_transport_vendor_summary_report",
                type: "POST",
                data: function (data) {
