    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">
                    Visa Vendor
                    <?php if ($CheckAccess['umrah_reports_vendors_vendor_reports_visa_vendor_export']) { ?>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Visa Vendor Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Visa Vendor Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_all_visa_vendor_report",
                type: "POST",
                data: function (data) {
