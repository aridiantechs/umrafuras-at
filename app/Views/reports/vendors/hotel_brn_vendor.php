    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">
                    Hotel BRN Vendor
                    <?php if ($CheckAccess['umrah_reports_vendors_vendor_reports_hotel_brn_vendor_export']) { ?>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Hotel BRN Vendor Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Hotel BRN Vendor Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_all_hotel_brn_vendor_report",
                type: "POST",
                data: function (data) {
