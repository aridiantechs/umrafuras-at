<?php
$session = session();
$SessionFilters = $session->get('PaxInMedinaSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">PAX In Medina
                    <?php if ($CheckAccess['umrah_reports_status_stats_export_pax_in_medina']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/pax_in_medina" target="_blank">Export Records
                    </a>
                    <?php } ?>
                </h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="return false;" class="section contact" id="PaxInMedinaSearchFilterForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="PaxInMedinaSessionFilters">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" id="FilterButtons">
                                                    <div class="form-group float-right">
                                                        <button onclick="PaxInMedinaFiltersFormSubmit( 'PaxInMedinaSearchFilterForm' );"
                                                                id="btnsearch" type="button" class="btn btn-success">
                                                            Search
                                                        </button>
                                                        <button onclick="ClearSession('PaxInMedinaSessionFilters');"
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="PaxInMedinaRecord" class="table table-hover non-hover display nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#PaxInMedinaRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Pax In Medina Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Pax In Medina Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_pax_in_medina_report",
                type: "POST",
            },
            "columnDefs": [
                {
    ...
    function PaxInMedinaFiltersFormSubmit(parent) {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            $("form#PaxInMedinaSearchFilterForm input#checkin_start_date").val('');
            $("form#PaxInMedinaSearchFilterForm input#checkin_end_date").val('');
            $("form#PaxInMedinaSearchFilterForm")[0].reset();
            dataTable.ajax.reload();
        }
    }
...
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_reports_status_stats_export_pax_in_medina']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/pax_in_medina" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
    <?php } ?>
</script>
