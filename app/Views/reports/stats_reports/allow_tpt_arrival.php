    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Allow TPT Arrival
                    <?php if ($CheckAccess['umrah_reports_status_stats_export_allow_tpt_arrival']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/allow_tpt_arrival" target="_blank">Export Records
                    </a>
                    <?php } ?>
                </h4>
            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="TPTType" name="TPTType"
                                                               placeholder="TPT Type" type="text"
                                                               value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="country">Seactor</label>
                                                        <input class="form-control" id="Seactor" name="Seactor"
                                                               placeholder="Seactor" type="text"
                                                               value="">
                                                    </div>
                                                </div>
...
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_reports_status_stats_export_allow_tpt_arrival']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/allow_tpt_arrival" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
    <?php } ?>
