...
$session = session();
$SessionFilters = $session->get('VisaIssuedSessionFilters');
$Country = $Agent = $Group = $PPTNO = $Pilgrim = $MofaNo = $VisaNo = $HTlCategory = '';
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Visa issue
                    <?php if ($CheckAccess['umrah_reports_status_stats_export_visa_issued']) { ?>
                        <a type="button" class="btn btn_customized  btn-sm float-right"
                           onclick="" href="<?= $path ?>exports/visa_issue" target="_blank"> Export Record
                        </a>
                    <?php } ?>
                </h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form method="post" onsubmit="return false;" class="section contact"
                      id="VisaIssuedStatsReportSearchFilter">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="VisaIssuedSessionFilters">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input value="<?= $Pilgrim ?>" type="text" class="form-control"
                                                       id="pilgrim"
                                        ...
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="VisaIssuedFiltersFormSubmit( 'VisaIssuedStatsReportSearchFilter' );"
                                                        id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('VisaIssuedSessionFilters');"
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="VisaIssueRecord" class="table table-hover non-hover display nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                                        ...
                                                        foreach ($records as $record) {
                                                           ...
                                                           <td>' . $record['VisaNumber'] . '</td>
                                                            <td>' . $record['CityName'] . '</td>
                                                              ...
                                                              <!--  <td>' . DATEFORMAT($record['VisaIssueDate']) . '</td> -->
                                                            <td>'.$Category.'</td>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        var dataTable = $('#VisaIssueRecord').DataTable({
            "processing": true,
            "searching": false,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Visa Issue",
                "info": "Showing _START_ to _END_ of _TOTAL_ Visa Issue",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_visa_issue",
                type: "POST"
            },
            "columnDefs": [
                {
    ...
    function VisaIssuedFiltersFormSubmit(parent) {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            $("form#VisaIssuedStatsReportSearchFilter")[0].reset();
            dataTable.ajax.reload();
        }
    }
</script>
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_reports_status_stats_export_visa_issued']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/visa_issue" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
    <?php } ?>
