    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Allow TPT Medina
                    <?php if ($CheckAccess['umrah_reports_status_stats_export_allow_tpt_medina_chk_out']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?=$path?>exports/allow_tpt_medina" target="_blank">Export Records
                    </a>
                    <?php } ?>
                </h4>
            </div>
