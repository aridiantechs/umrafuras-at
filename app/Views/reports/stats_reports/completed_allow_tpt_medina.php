    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Allow Transport Medina Completed
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/completed_allow_tpt_medina" target="_blank">Export Records
                    </a>
                </h4>
            </div>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="ReportTable" class="table table-hover non-hover display nowrap" style="width:100%">
                            ...
                            foreach ($records as $record) {
                                ...
                                $PilgrimLastActivity = PilgrimLastActivity($record['LeaderPilgrimUID'], 'allow-tpt-medina-status');
                                //echo "<pre>";print_r($PilgrimLastActivity);
                                $PilgrimCurrentActivity = PilgrimCurrentActivity($record['LeaderPilgrimUID'], 'check-in-medina',  $record['AID']);
                                ...
                                $PilgrimTransportActivity = PilgrimCurrentActivity($record['LeaderPilgrimUID'], 'allow-tpt-medina',  $record['RID']);
