    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Allow TPT Departure Completed
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/completed_allow_tpt_departure" target="_blank">Export Records
                    </a>
                </h4>
            </div>
...
<script type="application/javascript">
    ...
    setTimeout(function () {
        $('<a href="<?=$path?>exports/completed_allow_tpt_departure" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
