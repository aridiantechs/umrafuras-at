...
$Country = $Agent = $EntryPort = $PPTNo = $MofaNo = $VisaNo = $EntryStartDate = $EntryEndDate = '';
...
if (isset($SessionFilters['entry_port']) && trim($SessionFilters['entry_port']) != '') {
    $EntryPort = $SessionFilters['entry_port'];
}
...
if (isset($SessionFilters['entry_start_date']) && trim($SessionFilters['entry_start_date']) != '') {
    $EntryStartDate = $SessionFilters['entry_start_date'];
}

if (isset($SessionFilters['entry_end_date']) && trim($SessionFilters['entry_end_date']) != '') {
        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Without Voucher
                    <?php if ($CheckAccess['umrah_reports_stats_voucher_without_voucher_arrival_export']) { ?>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="return false;" class="section contact" id="WithoutVouchersArrivalSearchFilterForm">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="entry_port"
                                                               name="entry_port"
                                                               placeholder="Entry Port" value="<?=$EntryPort?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="">PPT#</label>
                                                        <input value="<?= $PPTNo ?>" type="text" class="form-control"
                                                               id="ppt_no"
                                                               name="ppt_no"
                                                               placeholder="PPT NO">
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?= $MofaNo ?>" type="text" class="form-control"
                                                               id="mofa_no"
                                                               name="mofa_no"
                                                               placeholder="MOFA NO">
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?= $VisaNo ?>" type="text" class="form-control"
                                                               id="visa_no"
                                                               name="visa_no"
                                                               placeholder="Visa NO">
                                                    </div>
                                                ...
                                                <div class="col-md-12"
                                                     id="WithoutVouchersArrivalReportAjaxResult"></div>
                                                <div class="col-md-12" id="FilterButtons">
                                                    <div class="form-group float-right">
                                                        <button onclick="WithoutVouchersArrivalSearchFilterFormSubmit( 'WithoutVouchersArrivalSearchFilterForm' );"
                                                                id="btnsearch" type="button" class="btn btn-success">
                                                            Search
                                                        </button>
                                                        <button onclick="ClearSession('WithoutVouchersArrivalSessionFilters');"
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    if (isset($SessionFilters) && $SessionFilters != '') { ?>
                        <div class="table-responsive mb-4 mt-4">
                            <table id="WithOutVouchersArrivalRecord" class="table table-hover non-hover display nowrap "
                                   style="width:100%">
                                <thead>
                                <tr>
                                    <th>#</th>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        <?php
        if(isset($SessionFilters) && $SessionFilters != ''){?>
        WithOutVouchersArrivalRecord();
        <?php }?>


    });

    function WithOutVouchersArrivalRecord() {
        var dataTable = $('#WithOutVouchersArrivalRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Without Vouchers Arrival Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Without Vouchers Arrival Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_without_voucher_arrival_report",
                type: "POST",
            },
            "columnDefs": [
                {
    ...
    function WithoutVouchersArrivalSearchFilterFormSubmit(parent) {

        var dataTable = $('#WithOutVouchersArrivalRecord').DataTable();
        var data = $("form#" + parent).serialize();
        var rslt = AjaxResponse('filters_session/create_filters_session', data);
        if (rslt.status == 'success') {
            GridMessages(parent, 'WithoutVouchersArrivalReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                location.reload();
            }, 500);
        }
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            $("form#WithoutVouchersArrivalSearchFilterForm input#entry_start_date").val('');
            $("form#WithoutVouchersArrivalSearchFilterForm input#entry_end_date").val('');
            $("form#WithoutVouchersArrivalSearchFilterForm")[0].reset();

            GridMessages('WithoutVouchersArrivalSearchFilterForm', 'WithoutVouchersArrivalReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                location.reload();
            }, 500);
        }
