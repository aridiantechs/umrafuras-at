...
$session = session();
$SessionFilters = $session->get('AllowHotelMeccaStatsReportSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head"> Allow HTL Mecca
                    <?php if ($CheckAccess['umrah_reports_status_stats_export_allow_htl_mecca']) { ?>
                        <a type="button" class="btn btn_customized  btn-sm float-right"
                           onclick="" href="<?= $path ?>exports/arrival_htl_mecca" target="_blank">Export Records
                        </a>
                    <?php } ?>
                </h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form class="section contact" id="AllowHotelMeccaStatsReportForm" name="AllowHotelMeccaStatsReportForm"
                      onsubmit="AllowHotelMeccaStatsReportFiltersFormSubmit('AllowHotelMeccaStatsReportForm'); return false;">
                    <input type="hidden" name="SessionKey" id="SessionKey"
                           value="AllowHotelMeccaStatsReportSessionFilters">
                            ...
                            <div id="FilterDetails" class="collapse show" aria-labelledby=""
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="AllowHotelMeccaStatsAjaxResult"></div>
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="AllowHotelMeccaStatsReportFiltersFormSubmit('AllowHotelMeccaStatsReportForm');"
                                                        id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('AllowHotelMeccaStatsReportSessionFilters');"
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="AllowHotelMeccaRecords" class="table table-hover non-hover display nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
...
<script type="application/javascript">
    ...
    $(document).ready(function () {
        var dataTable = $('#AllowHotelMeccaRecords').DataTable({
            "processing": true,
            "searching": false,
            "pageLength": 100,
            "lengthChange": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Allow Hotel Mecca",
                "info": "Showing _START_ to _END_ of _TOTAL_ Allow Hotel Mecca",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_allow_hotel_mecca",
                type: "POST"
            },
            "columnDefs": [
                {
    ...
    function AllowHotelMeccaStatsReportFiltersFormSubmit(parent) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages(parent, 'AllowHotelMeccaStatsAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('AllowHotelMeccaStatsReportForm', 'AllowHotelMeccaStatsAjaxResult', 'alert-success', rslt.msg, 250);
            $("form#AllowHotelMeccaStatsReportForm")[0].reset();
            setTimeout(function () {
                dataTable.ajax.reload();
            }, 500);
        }
    ...
    <?php if ($CheckAccess['umrah_reports_status_stats_export_allow_htl_mecca']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/arrival_htl_mecca" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
    <?php } ?>
