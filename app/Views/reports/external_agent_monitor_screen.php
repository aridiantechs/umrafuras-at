    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">External Agent Monitor Screen Report
                    <?php if ($CheckAccess['umrah_reports_stats_statistics_external_monitor_screen_export']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?=$path?>exports/external_agent_monitor_screen" target="_blank">Export Records
                    </a> <?php } ?>
                </h4>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" id="FilterButtons">                                                    <div class="form-group float-right">
                                                        <button onclick=""
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ External Agent Monitor Screen Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ External Agent Monitor Screen Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_external_agent_monitor_screen_report",
                type: "POST",
                data: function (data) {
...
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_reports_stats_statistics_external_monitor_screen_export']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/external_agent_monitor_screen" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100); <?php } ?>
