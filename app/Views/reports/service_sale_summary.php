    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Services Sale Summary
                    <?php if ($CheckAccess['umrah_reports_stats_sale_service_sale_summary_export']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?=$path?>exports/service_sale_summary" target="_blank"> Export Record
                    </a> <?php } ?>
                </h4>
            </div>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Services Sale Summary",
                "info": "Showing _START_ to _END_ of _TOTAL_ Services Sale Summary",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_service_sale_summary_report",
                type: "POST",
                data: function (data) {
...
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_reports_stats_sale_service_sale_summary_export']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/service_sale_summary" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100); <?php } ?>
