    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Hotel Balance Visa
                    <?php if ($CheckAccess['umrah_reports_stats_brn_hotel_hotel_brn_balance_visa_export']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/htl_balance_visa" target="_blank"> Export Record
                    </a> <?php } ?>
                </h4>
            </div>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Hotel Use Balance Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Hotel Balance Visa Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_all_hotel_balance_visa_report",
                type: "POST",
                data: function (data) {
...
<script type="application/javascript">
   ...
   /* $('#ReportTable').DataTable({
    ...
    <?php if ($CheckAccess['umrah_reports_stats_brn_hotel_hotel_brn_balance_visa_export']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/htl_balance_visa" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100); <?php } ?>
