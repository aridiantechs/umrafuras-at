    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Transport BRN Use Visa
                    <?php if ($CheckAccess['umrah_reports_stats_brn_transport_transport_brn_use_visa_export']) { ?>
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/trp_use_visa" target="_blank"> Export Record
                    </a> <?php } ?>
                </h4>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="">Used ID</label>
                                                        <input type="text" class="form-control" name="UsedID"
                                                               value=""
                                                               placeholder="Used ID">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control multidate validate[required,future[now]]"
                                                               name="UsedDate" id="UsedDate" readonly
                                                               placeholder="" value=""
                                                        >
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#ReportTable').DataTable({
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Transport Use Visa Report",
                "info": "Showing _START_ to _END_ of _TOTAL_ Transport Use Visa Report",
            },
            "ajax": {
                url: "<?= $path ?>reports/fetch_all_transport_use_visa_report",
                type: "POST",
                data: function (data) {
...
<script type="application/javascript">
    ...
    <?php if ($CheckAccess['umrah_reports_stats_brn_transport_transport_brn_use_visa_export']) { ?>
    setTimeout(function () {
        $('<a href="<?=$path?>exports/trp_use_visa" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100); <?php } ?>
