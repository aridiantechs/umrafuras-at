    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">PPT Managment Pending
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/ppt_management_pending" target="_blank"> Export Record
                    </a>
                </h4>
            </div>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="ReportTable" class="table table-hover non-hover display nowrap cell-border"
                            ...
                            <tr>
                                <td>1</td>
                                <td>25666</td>
                                <td>ARIES TRAVEL & TOURS (PVT) LTD</td>
                                <td>6099</td>
                                <td>BT 002</td>
                                <td>WAZIR AHMAD</td>
                                <td>MG1172121</td>
                                ...
                                <td>10/3/2019</td>
                                <td>10:50:00 AM</td>
                                <td>JED - King Abdul Aziz International Airport</td>
                                <td>ByAir</td>
                                <td>ALSAODYH</td>
                                <td>3801</td>
                                <td>Rehman</td>
...
<script type="application/javascript">
    ...
    setTimeout(function () {
        $('<a href="<?=$path?>exports/ppt_management_pending" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
