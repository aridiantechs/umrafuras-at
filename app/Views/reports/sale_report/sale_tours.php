                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="dodgerblue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_tour_detail_report" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="green-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_tour_country_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            Package Category Wise</h6>
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_tour_package_category_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="orange-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_tour_month_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_tour_year_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        <div class="rs-icon pb-3">
                                            <img src="<?= $template ?>assets/img/rs-icons/icon-rs-1.png"></div>
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            Package Category Month Wise</h6>
                                        <div class="dodgerblue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_tour_package_category_Monthwise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
