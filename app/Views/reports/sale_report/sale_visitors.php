                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="dodgerblue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_visitor_detail_report" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="green-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_visitor_country_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            Successful Product Wise</h6>
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_visitor_successful_product_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            UnSuccessful Product Wise</h6>
                                        <div class="orange-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_visitor_unsuccessful_product_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_visitor_month_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            Year Wise</h6>
                                        <div class="dodgerblue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_visitor_year_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
