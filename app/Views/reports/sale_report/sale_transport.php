                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="dodgerblue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_transport_detail_report" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="green-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_transport_country_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_transport_category_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_transport_month_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 mb-xl-0 mb-lg-0 mb-md-4 mb-4 mt-4">
                        <div class="widget widget-card-four btb-box p-xl-3 p-lg-3 p-md-3 p-3">
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="orange-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_transport_year_wise" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        <div class="rs-icon pb-3">
                                            <img src="<?= $template ?>assets/img/rs-icons/icon-rs-1.png"></div>
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">
                                            Category Wise with Month & Country </h6>
                                        <div class="dodgerblue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/sale_transport_category_with_month_and_country" target="_blank"> Read More </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
