            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">External Agents
                    <a type="button" class="btn btn_customized  btn-sm float-right"
                       onclick="" href="<?= $path ?>exports/external_agent" target="_blank"> Export Record
                    </a>
                </h4>
...
<script type="application/javascript">
    ...
    setTimeout(function () {
        $('<a href="<?=$path?>exports/external_agent" target="_blank" class="btn btn_customized  btn-sm float-right">Export Record</a>').appendTo(".table-responsive");
    }, 100);
