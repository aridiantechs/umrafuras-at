                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_visa_issue" target="_blank"> Read
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_reject_visa" target="_blank"> Read
                                                More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="green-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_refund_visa" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_visa_detail" target="_blank"> Read
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Vendor
                                            Country Wise</h6>
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_visa_vendor_country_wise" target="_blank">
                                                Read
                                                More</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_visa_country_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="orange-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_visa_month_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Year
                                            Wise</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_visa_year_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
