                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_confirm_booking" target="_blank">
                                                Read More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_refund_booking" target="_blank">
                                                Read
                                                More</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="green-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_change_booking" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_detail_report" target="_blank"> Read
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="green-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_country_wise" target="_blank"> Read
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Category
                                            Wise</h6>
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_category_wise" target="_blank"> Read
                                                More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_month_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Year
                                            Wise</h6>
                                        <div class="blue-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>reports/purchase_tpt_year_wise" target="_blank">
                                                Read More</a></div>
                                    </div>
                                </div>
                            </div>
