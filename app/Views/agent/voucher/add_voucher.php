                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Add Voucher <span id="ExportPackage"> </span>
                        ...
                        <div class="widget-content widget-content-area">
                            <form enctype="multipart/form-data" class="validate" method="post" action="#"
                                ...
                                <input type="hidden" name="VoucherAgentID" id="VoucherAgentID" value="0">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        if ($session['account_type'] == "external_agent" || $session['account_type'] == "agent") {
                                                            ...
                                                            echo '</select>';
//                                                            if ($AgentLogged) {
//                                                                echo ' <span class="form-control"  id="Agent" name="AgentName" placeholder="AgentName">' . $session['name'] . '</span>
...
<script>
    ...
    function LandAttachmentFormHTML(cnt, self) {
        ...
        html +=
            '        <input type="hidden" id="Traveltype" name="Traveltype[]" value="Land"> <input type="hidden" name="TravelSelf[]" value="' + self + '"><input type="hidden" name="FlightType[]" value="Departure">\n' +
            ...
            '        <div class="col-md-2">  <div class="form-group mb-3"> <label for="country">Departure Time</label> <input type="time" class="form-control validate[required]" id="DepartureTime" name="DepartureTime[]"  placeholder="Departure Time"> </div> </div>\n' +
            '        <div class="col-md-2">  <div class="form-group mb-3"> <label for="country">Arrival Date</label> <input type="date" class="form-control validate[required]" id="ArrivalDate" name="ArrivalDate[]" min="' + mindate + '" max="' + maxdate + '"  aria-describedby="emailHelp1" value="' + maxdate + '" placeholder="Arrival Date">  </div> </div>\n' +
            '        <div class="col-md-2">  <div class="form-group mb-3"> <label for="country">Arrival Time</label> <input type="time" class="form-control validate[required]" id="ArrivalTime" name="ArrivalTime[]" aria-describedby="emailHelp1" placeholder="Arrival Time"></div></div>\n' +
            '        <div class="col-md-1">  <label for="country"> </label> </div>' +
            '        <div class = "col-md-12"><hr></div>\n';
        ...
        html2 +=
            ...
            '        <div class="col-md-2"> <div class="form-group mb-3">  <label for="country">Port</label>  <select class="form-control validate[required]" id="SectorTo' + cnt + '"  name="SectorTo[]"> <option value="">Please Select</option> <?=$landbordershtml?> </select> </div> </div>\n' +
            '        <div class="col-md-2"> <div class="form-group mb-3">  <label for="country">Border Cities</label>  <select class="form-control validate[required]" id="SectorFrom' + cnt + '"  name="SectorFrom[]"> <option value="">Please Select</option> <?=$landbordercitieshtml?> </select> </div> </div>\n' +
            '        <div class="col-md-3">  <div class="form-group mb-3"> <label for="country">Ref Number</label> <input type="text" class="form-control" id="Reference" name="Reference[]"  aria-describedby="emailHelp1"  placeholder="Ref Number">  </div> </div>\n' +
            '        <div class="col-md-3">  <div class="form-group mb-3"> <label for="country">PNR</label> <input type="text" class="form-control" id="PNR" name="PNR[]" aria-describedby="emailHelp1"  placeholder="PNR"> </div> </div>\n' +
            '        <div class="col-md-2">  <div class="form-group mb-3"> <label for="country">Departure Date</label>  <input type="date" class="form-control validate[required]"  id="DepartureDate" name="DepartureDate[]"  min="' + mindate + '" max="' + maxdate + '"  value="' + mindate + '" placeholder="Departure Date">  </div> </div>\n' +
    ...
    function RequstedAccomodationAttachmentFormHTML(cnt) {
        ...
        var mindate = $("#VoucherArrivalDate").val();
        var maxdate = $("#ReturnDate").val();
        html = '<div class="row accomodationclass" id="RequestedAccomodationCount_' + cnt + '" name="RequestedAccomodationCount">\n' +
            ...
            '<div class="col-md-2">  <div class="form-group mb-3"> <label for="country">City</label> <input type="hidden" name="Self[' + cnt + ']" value="0"> <select class="form-control validate[required]" id="City" onChange="LoadHotelByCites(this.value,' + cnt + ')"  name="City[' + cnt + ']">  </select> </div>  </div>\n' +
            '<div class="col-md-3">  <div class="form-group mb-3"> <label for="country">Hotel</label>  <select class="form-control validate[required]" id="Hotel_' + cnt + '"  name="Hotels[' + cnt + ']" onchange="GetRoomRate(\'RequestedAccomodationCount_' + cnt + '\',' + cnt + ');">   </select>    </div> </div>\n' +
            '<div class="col-md-2">   <div class="form-group mb-3">  <label for="country">Check-In</label>   <input type="date" class="form-control validate[required,funcCall[checkindate]]" data-rowid="' + cnt + '" id="CheckIn' + cnt + '" name="CheckIn[' + cnt + ']"   aria-describedby="emailHelp1"  placeholder="Check IN" min="' + mindate + '" max="' + maxdate + '" value="' + mindate + '">   </div>   </div>\n' +
            '<div class="col-md-2">   <div class="form-group mb-3">  <label for="country">Check-Out</label> <input type="date" class="form-control validate[required,funcCall[checkoutdate]]" id="CheckOut' + cnt + '"  name="CheckOut[' + cnt + ']"  aria-describedby="emailHelp1"  placeholder="Check Out" min="' + mindate + '" max="' + maxdate + '" value="' + maxdate + '" onchange="GetNoOfDaysRate(\'RequestedAccomodationCount_' + cnt + '\',' + cnt + ',0)";>   </div>  </div>\n' +
            '<div class="col-md-2">   <div class="form-group mb-3">  <label for="country">BRN</label> <select class="form-control validate[required]"  id="AccommodationBRN_' + cnt + '"  name="AccommodationBRN[' + cnt + ']">' + BRN + '</select></div>  </div>\n' +
            ...
            '<div class="col-md-3"><input type="hidden" name="AccomodationId[' + cnt + '][]" id="AccomodationId_' + cnt + '"> <div class="form-group mb-3">  <label for="country">Room Type</label>  <select class="form-control RoomTypeClass validate[required]" id="RoomType_' + cnt + '_' + cnt + '"  name="RoomType[' + cnt + '][]" onchange="GetRoomRate(\'RequestedAccomodationCount_' + cnt + '\',' + cnt + ',\'RequestedAccomodationRoomTypeCount' + cnt + '_' + cnt + '\',' + cnt + ');">   <option value="">Please Select</option>  <?=$RoomTypes?>  </select><input type="hidden"  name="TempAccommodation[RoomType][]" value="">  </div> </div>\n' +
            '<div class="col-md-2">   <div class="form-group mb-3">  <label for="country" id="noofroomsbeds' + cnt + '_' + cnt + '">No Of Beds</label> <input type="number" class="form-control NoOfBeds NoOfBedsClass validate[required,funcCall[checknumberofbeds]]" min="1" max="' + CountPilgrim + '" value="' + CountPilgrim + '" required="required" id="NoOfBeds_' + cnt + '_' + cnt + '"  name="NoOfBeds[' + cnt + '][]"  onchange="GetRoomRate(\'RequestedAccomodationCount_' + cnt + '\',' + cnt + ',\'RequestedAccomodationRoomTypeCount' + cnt + '_' + cnt + '\',' + cnt + ');"  aria-describedby="emailHelp1"  placeholder="No Of Beds"><input type="hidden"  name="TempAccommodation[NoOfBeds][]" value="">   </div>  </div>\n' +
    ...
    function RequstedSelfAccomodationAttachmentFormHTML(cnt) {
        ...
        html = '<div class="row accomodationclass" id="RequestedAccomodationCount_' + cnt + '">\n' +
            ...
            '<div class="col-md-2">  <div class="form-group mb-3"> <label for="country">City</label>  <input type="hidden" name="Self[' + cnt + ']" value="1"><select class="form-control" id="City" onChange="LoadSelfHotelByCites(this.value,' + cnt + ')"  name="City[' + cnt + ']">  </select> </div>  </div>\n' +
            '<div class="col-md-3">  <div class="form-group mb-3"> <label for="country">Hotel</label>  <select class="form-control" id="Hotel_' + cnt + '"  name="Hotels[' + cnt + ']" onchange="GetHotelName(this.value,' + cnt + ');">   </select>    </div> </div>\n' +
            '<div class="col-md-2">   <div class="form-group mb-3">  <label for="country">Check-In</label>   <input type="date" class="form-control validate[required,funcCall[checkindate]]" data-rowid="' + cnt + '" id="CheckIn' + cnt + '" name="CheckIn[' + cnt + ']" min="' + mindate + '" max="' + maxdate + '" value="' + mindate + '"   aria-describedby="emailHelp1"  placeholder="Check Out">   </div>   </div>\n' +
            '<div class="col-md-2">   <div class="form-group mb-3">  <label for="country">Check-Out</label> <input type="date" class="form-control validate[required,funcCall[checkoutdate]]" id="CheckOut' + cnt + '"  name="CheckOut[' + cnt + ']"   aria-describedby="emailHelp1" min="' + mindate + '" max="' + maxdate + '" value="' + maxdate + '"  placeholder="Check Out" onchange="GetNoOfDaysRate(\'RequestedAccomodationCount_' + cnt + '\',' + cnt + ',1)";>   </div>  </div>\n' +
            '<div class="col-md-1">  <label for="country"><a name="removeButton" href="javascript:void(0);" onClick="RemoveRequstedAccomodationAttachmentRow(' + cnt + ')" id="removeButton" class="float-right" style="color: #dd0317;padding-left: 10px;"><span> <i class="fa fa-trash" title="Remove"></i></span></a></label><div class="form-group mb-3"></div></div>\n' +
            '<div class="col-md-12" id="RequestedAccomodationRoomType' + cnt + '">\n' +
            '<div class="row" id="RequestedAccomodationRoomTypeCount' + cnt + '_' + cnt + '">\n' +
    ...
    function VoucherFormSubmit() {
        ...
        if (response.status == 'success') {
            ...
            $("a[href$='finish']").hide();
            setTimeout(function () {
                location.href = "<?=base_url('agent/voucher')?>";
                PlzWait('hide');
            }, 2000)
        } else {
