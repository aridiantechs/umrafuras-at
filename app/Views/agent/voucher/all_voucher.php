...
$session = session();
$SessionFilters = $session->get('AllVoucherSessionFilters');
$Country = $Agent = $VoucherNo = $CreateDateFrom = $CreateDateTo = $Status =  '';
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">All Vouchers
                    <?php if($CheckAccess['umrah_travel_check_all_voucher_add']){?>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="AllVoucherFiltersFormSubmit( 'AllVouchersSearchFiltersForm' ); return false;" class="section contact" id="AllVouchersSearchFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="AllVoucherSessionFilters">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="status"
                                                        name="status">
                                                    <option <?=( (isset($Status) && $Status == '')? 'selected' : '' )?> value="">Please Select</option>
                                                    <option <?=( (isset($Status) && $Status == 'Approved')? 'selected' : '' )?> value="Approved">Approved</option>
                                                    <option <?=( (isset($Status) && $Status == 'Executed')? 'selected' : '' )?> value="Executed">Executed</option>
                                                    <option <?=( (isset($Status) && $Status == 'Pending')? 'selected' : '' )?> value="Pending">Pending</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12" id="AllVouchersReportAjaxResult"></div>
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="AllVoucherFiltersFormSubmit( 'AllVouchersSearchFiltersForm' );" id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('AllVoucherSessionFilters');" id="btnreset" type="button" class="btn btn-danger">Clear
                                                    Filter
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="AllVouchersRecord" class="table table-hover non-hover display nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                                            ...
                                                                            <a class="dropdown-item" href="#" onclick="LoadModal(\'agent/voucher/services_ziyarat_refund_modal\', ' . $voucher['UID'] . ', \'modal-lg\')">Add Refund</a>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#AllVouchersRecord').DataTable({
            "processing": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ All Vouchers",
                "info": "Showing _START_ to _END_ of _TOTAL_ All Vouchers",
            },
            "ajax": {
                url: "<?= $path ?>agent/fetch_all_vouchers",
                type: "POST",
            },
            "columnDefs": [
                {
    ...
    function AllVoucherFiltersFormSubmit(parent) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages(parent, 'AllVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('AllVouchersSearchFiltersForm', 'AllVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                $("form#AllVouchersSearchFiltersForm input#create_date_from").val('');
                $("form#AllVouchersSearchFiltersForm input#create_date_to").val('');
                $("form#AllVouchersSearchFiltersForm select#status").val('');
                $("form#AllVouchersSearchFiltersForm")[0].reset();
                dataTable.ajax.reload();
            }, 500);
        }
    }
