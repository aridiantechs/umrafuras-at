...
$session = session();
$SessionFilters = $session->get('AllUpdatedVoucherSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Updated Vouchers
                    <?php
                        if($CheckAccess['umrah_travel_check_updated_voucher_add']){?>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="AllUpdatedVoucherFiltersFormSubmit( 'AllUpdatedVouchersSearchFiltersForm' ); return false;"
                      class="section contact" id="AllUpdatedVouchersSearchFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="AllUpdatedVoucherSessionFilters">
                            ...
                            <div id="FilterDetails" class="collapse show" aria-labelledby=""
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="AllUpdatedVouchersReportAjaxResult"></div>
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="AllUpdatedVoucherFiltersFormSubmit( 'AllUpdatedVouchersSearchFiltersForm' );" id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('AllUpdatedVoucherSessionFilters');" id="btnreset" type="button" class="btn btn-danger">Clear
                                                    Filter
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="AllUpdatedVouchersRecord" class="table table-hover non-hover display nowrap" style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>Country</th>
                            ...
                            foreach ($Vouchers as $voucher) {
                                ...
                                <tr>
                                    ...
                                    <td>' . UserNameByID($voucher['ModifiedBy']) . '</td>
                                    <td>' . DATEFORMAT($voucher['ModifiedDate']) . '</td>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#AllUpdatedVouchersRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ All Updated Vouchers",
                "info": "Showing _START_ to _END_ of _TOTAL_ All Updated Vouchers",
            },
            "ajax": {
                url: "<?= $path ?>agent/fetch_all_updated_vouchers",
                type: "POST",
            },
            "columnDefs": [
                {
    ...
    function AllUpdatedVoucherFiltersFormSubmit(parent) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages(parent, 'AllUpdatedVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('AllUpdatedVouchersSearchFiltersForm', 'AllUpdatedVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                $("form#AllUpdatedVouchersSearchFiltersForm input#create_date_from").val('');
                $("form#AllUpdatedVouchersSearchFiltersForm input#create_date_to").val('');
                $("form#AllUpdatedVouchersSearchFiltersForm")[0].reset();
                dataTable.ajax.reload();
            }, 500);
        }
    }
