...
$session = session();
$SessionFilters = $session->get('AllExecutedVoucherSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Executed Vouchers
                </h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="AllExecutedVoucherFiltersFormSubmit( 'AllExecutedVouchersSearchFiltersForm' ); return false;"
                      class="section contact" id="AllExecutedVouchersSearchFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="AllExecutedVoucherSessionFilters">
                            ...
                            <div id="FilterDetails" class="collapse show " aria-labelledby=""
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="AllExecutedVouchersReportAjaxResult"></div>
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="AllExecutedVoucherFiltersFormSubmit( 'AllExecutedVouchersSearchFiltersForm' );" id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('AllExecutedVoucherSessionFilters');" id="btnreset" type="button" class="btn btn-danger">Clear
                                                    Filter
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="AllExecutedVouchersRecord" class="table table-hover non-hover display nowrap" style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>Country</th>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#AllExecutedVouchersRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ All Executed Vouchers",
                "info": "Showing _START_ to _END_ of _TOTAL_ All Executed Vouchers",
            },
            "ajax": {
                url: "<?= $path ?>agent/fetch_all_executed_vouchers",
                type: "POST",
            },
            "columnDefs": [
                {
    ...
    function AllExecutedVoucherFiltersFormSubmit(parent) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages(parent, 'AllExecutedVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('AllExecutedVouchersSearchFiltersForm', 'AllExecutedVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                $("form#AllExecutedVouchersSearchFiltersForm input#create_date_from").val('');
                $("form#AllExecutedVouchersSearchFiltersForm input#create_date_to").val('');
                $("form#AllExecutedVouchersSearchFiltersForm")[0].reset();
                dataTable.ajax.reload();
            }, 500);
        }
    }
