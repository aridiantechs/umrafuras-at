...
$session = session();
$SessionFilters = $session->get('AllRefundVoucherSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Refund Vouchers</h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="AllRefundVoucherFiltersFormSubmit( 'AllRefundVouchersSearchFiltersForm' ); return false;"
                      class="section contact" id="AllRefundVouchersSearchFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="AllRefundVoucherSessionFilters">
                            ...
                            <div id="FilterDetails" class="collapse show " aria-labelledby=""
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="AllRefundVouchersReportAjaxResult"></div>
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="AllRefundVoucherFiltersFormSubmit( 'AllRefundVouchersSearchFiltersForm' );" id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('AllRefundVoucherSessionFilters');" id="btnreset" type="button" class="btn btn-danger">Clear
                                                    Filter
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="AllRefundVouchersRecord" class="table table-hover non-hover display nowrap" style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>Country</th>
                            ...
                            foreach ($Vouchers as $voucher) {
                                ...
                                <tr>
                                    ...
                                    <td>N/A</td>
                                   <td>' . DATEFORMAT($voucher['RefundDate']) . '</td>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#AllRefundVouchersRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ All Refund Vouchers",
                "info": "Showing _START_ to _END_ of _TOTAL_ All Refund Vouchers",
            },
            "ajax": {
                url: "<?= $path ?>agent/fetch_all_refund_vouchers",
                type: "POST",
            },
            "columnDefs": [
                {
    ...
    function AllRefundVoucherFiltersFormSubmit(parent) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages(parent, 'AllRefundVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('AllRefundVouchersSearchFiltersForm', 'AllRefundVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                $("form#AllRefundVouchersSearchFiltersForm input#create_date_from").val('');
                $("form#AllRefundVouchersSearchFiltersForm input#create_date_to").val('');
                $("form#AllRefundVouchersSearchFiltersForm")[0].reset();
                dataTable.ajax.reload();
            }, 500);
        }
    }
