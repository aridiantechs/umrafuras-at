...
$session = session();
$SessionFilters = $session->get('AllPendingVoucherSessionFilters');
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Pending Vouchers
                    <?php
                        if($CheckAccess['umrah_travel_check_pending_voucher_add']){?>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="AllPendingVoucherFiltersFormSubmit( 'AllPendingVouchersSearchFiltersForm' ); return false;"
                      class="section contact" id="AllPendingVouchersSearchFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="AllPendingVoucherSessionFilters">
                            ...
                            <div id="FilterDetails" class="collapse show " aria-labelledby=""
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="AllPendingVouchersReportAjaxResult"></div>
                                        <div class="col-md-12" id="FilterButtons">
                                            <div class="form-group float-right">
                                                <button onclick="AllPendingVoucherFiltersFormSubmit( 'AllPendingVouchersSearchFiltersForm' );" id="btnsearch" type="button" class="btn btn-success">
                                                    Search
                                                </button>
                                                <button onclick="ClearSession('AllPendingVoucherSessionFilters');" id="btnreset" type="button" class="btn btn-danger">Clear
                                                    Filter
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="AllPendingVouchersRecord" class="table table-hover non-hover display nowrap" style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>Country</th>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#AllPendingVouchersRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ All Pending Vouchers",
                "info": "Showing _START_ to _END_ of _TOTAL_ All Pending Vouchers",
            },
            "ajax": {
                url: "<?= $path ?>agent/fetch_all_pending_vouchers",
                type: "POST",
                data: function (data) {
    ...
    function AllPendingVoucherFiltersFormSubmit(parent) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages(parent, 'AllPendingVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            ...
            GridMessages('AllPendingVouchersSearchFiltersForm', 'AllPendingVouchersReportAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                $("form#AllPendingVouchersSearchFiltersForm input#create_date_from").val('');
                $("form#AllPendingVouchersSearchFiltersForm input#create_date_to").val('');
                $("form#AllPendingVouchersSearchFiltersForm")[0].reset();
                dataTable.ajax.reload();
            }, 500);
        }
    }
