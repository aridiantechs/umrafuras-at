    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">External Agent
                    <!--  --><?php
                    /*                    echo " <pre>";
                                        print_r($session);
                                        exit;
                    ...
                    <!--                    --><?php
                    //                    if ($CheckAccess['agent_add_new_agent']) {
                    //                        ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto">
                                            <div class="row">
                                                ...
                                                <!--                                                               value="--><?//= ((isset($session['AgentSearchFilter']['email'])) ? $session['AgentSearchFilter']['email'] : '') ?><!--"-->
                                                <!--                                                               placeholder="Email">-->
                                                <!--                                                    </div>-->
                                                <!--                                                </div>-->
                                                <!--                                                <div class="col-md-3">-->
                                                ...
                                                <!--                                                               value="--><?//= ((isset($session['AgentSearchFilter']['phone_number'])) ? $session['AgentSearchFilter']['phone_number'] : '') ?><!--"-->
                        ...
                        <table id="MainRecords" class="table table-hover non-hover display nowrap" style="width:100%">
                            ...
                            foreach ($records as $record) {
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                     <a class="dropdown-item" href="#" onclick="LoadModal(\'agent/main_form\', ' . $record['UID'] . ', \'modal-lg\')">Update</a>
                                    <a class="dropdown-item" href="#" onclick="DeleteAgent(' . $record['UID'] . ');">Delete</a>
                                </div>';
...
<script type="application/javascript">
    ...
    function DeleteAgent(UID) {
        if (confirm("Are You Want To Remove External Agent")) {
