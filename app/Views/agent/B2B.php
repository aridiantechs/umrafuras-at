...
$session = session();
$SessionFilters = $session->get('B2bPilgrimsSessionFilters');
$Country = $Agent = $Group = $Pilgrim = $PPTNo = $PilgrimStatus = '';
...
?>
            ...
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <h4 class="page-head">B2B Pilgrims
                        <?php
                            if($CheckAccess['umrah_groups_pilgrim_b2b_add_new']){?>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing <?= (($AgentLogged) ? 'd-none' : '') ?>">
                    <form method="post" name="B2BPilgrimsForm" id="B2BPilgrimsForm"
                          onsubmit="B2BPilgrimsFormSubmit('B2BPilgrimsForm'); return false;">
                        <input type="hidden" name="SessionKey" id="SessionKey" value="B2bPilgrimsSessionFilters">
                                ...
                                <div id="FilterDetails" class="collapse show" aria-labelledby=""
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" id="B2BPilgrimsAjaxResult"></div>
                                            <div class="col-md-12" id="FilterButtons">
                                                <div class="form-group float-right">
                                                    <button onclick="B2BPilgrimsFormSubmit('B2BPilgrimsForm');"
                                                            id="btnsearch" type="button" class="btn btn-success">
                                                        Search
                                                    </button>
                                                    <button onclick="ClearSession('B2bPilgrimsSessionFilters');"
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="table-responsive mb-4 mt-4 datatableparentdiv ">
                            <table id="B2BPilgrimsRecord" class="table table-hover non-hover display nowrap"
                                   style="width:100%">
                                <thead>
                                <tr>
                                    <th>#</th>
                                ...
                                //                                {
                                                                ...
                                                                <tr>
                                                                     <td>' . $cnt . '</td>
                                                                     <td>N/A</td>
                                                                     <td>' . CountryName($record['AgentCountryID']) . '</td>
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#B2BPilgrimsRecord').DataTable({
                "processing": true,
                "searching": false,
                ...
                "order": [],
                "language": {
                    "lengthMenu": "Show _MENU_ B2B Pilgrims",
                    "info": "Showing _START_ to _END_ of _TOTAL_ B2B Pilgrims",
                },
                "ajax": {
                    url: "<?= $path ?>agent/fetch_b2b_pilgrims",
                    type: "POST"
                },
                "columnDefs": [
                    {
        ...
        function B2BPilgrimsFormSubmit(parent) {
            ...
            if (rslt.status == 'success') {
                ...
                GridMessages(parent, 'B2BPilgrimsAjaxResult', 'alert-success', rslt.msg, 250);
                setTimeout(function () {
                    dataTable.ajax.reload();
                }, 500);
            }
        ...
        function ClearSession(SessionKey) {
            ...
            if (rslt.status == 'success') {
                ...
                GridMessages('B2BPilgrimsForm', 'B2BPilgrimsAjaxResult', 'alert-success', rslt.msg, 250);
                $("form#B2BPilgrimsForm")[0].reset();
                setTimeout(function () {
                    dataTable.ajax.reload();
                }, 500);
            }
