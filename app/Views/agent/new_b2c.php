                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4><?= (isset($pilgrim_data['UID']) ? 'Pilgrim Updation' : 'Pilgrim Registration') ?></h4>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control validate[required]"
                                                                    id="Agent"
                                                                    name="Agent"
                                                                    onchange="LoadGroupsByAgentID(this.value);">
...
<!--                                                                   value="--><?//= $pilgrim_passport_data['DateOfIssue'] ?><!--">-->
<!--                                                        </div>-->
<!--                                                    </div>-->
<!--                                                    <div class="col-md-2">-->
<!--                                                        <div class="form-group">-->
...
<!--                                                                   value="--><?//= $pilgrim_passport_data['DateOfExpiry'] ?><!--">-->
<!--                                                        </div>-->
<!--                                                    </div>-->
                                ...
                                <section>
                                    <div id="AccountDetails">
                                        <div class="row">
                                            <div class="col-md-12 mx-auto">
                                                <div class="row <?= (isset($pilgrim_data['UID']) ? 'd-none' : '') ?>">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <button id="multiple-messages" class="btn btn_customized float-right"
                                                        onclick="PigrimFormSubmit()">Save
                                                    Changes
                                                </button>
                                            </div>
                                        </div>
