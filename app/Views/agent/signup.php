...
<div class="form-container">
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <p class="signup-link">Already have an account? <a href="<?= $path ?>home/login">Log in</a></p>
    ...
    <div class="form-image">
        <div class="l-image" style="background-image:url('<?= $template ?>assets/img/shield_logo.png')"></div>
    </div>
</div>
