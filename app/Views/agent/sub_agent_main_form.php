...
if ($host == "localhost") {
    ...
    $Name = str_replace("panel.", "", $_SERVER['HTTP_HOST']);
...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><?= $head ?> Sub Agent </h5>
...
<form enctype="multipart/form-data" class="validate" method="post" action="#" id="AgentAddForm" name="AgentAddForm">
    <div class="modal-body">
        ...
        <input type="hidden" id="Type" name="Type" value="sub_agent">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group mb-4">
                    <label for="Email">Parent Agent</label>
                    <?php
                    if ($session['account_type'] == 'agent' || $session['account_type'] == "external_agent") {
                        echo '<select class="form-control validate[required]"  id="AgentID" name="AgentID">';
                        foreach ($AllAgents as $agent)
                        {
                            $selected = (($profile['ParentID'] == $agent['UID']) ? 'selected' : '');
...
//                        }
            ...
            <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select class="form-control validate[required]" id="SalesAgent"
                            name="SalesAgent">
                        <?php
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control <?= (isset($profile['UID']) ? '' : 'validate[required]') ?>"
                           id="AgentLogo"
                ...
                <div class="row" id="AttachRows" name="AttachRows">
                    <div class="col-md-5">
                        <div class="form-group mb-4">
                            ...
                            <input type="text"
                                   class="form-control <?= (($update_id > 0) ? '' : 'validate[required]') ?>"
...
<script>
    ...
    function AgentFormSubmit() {
        ...
        response = AjaxUploadResponse("form_process/sub_agent_form_submit", phpdata);
