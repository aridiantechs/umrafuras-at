...
<!--                                        <a  class="btn btn-success" href="javascript:void(0);">Add</a>-->
<!--                                    </div>-->
                                    <div class="col-md-12 col-sm-12 col-12 mt-5">
                                        <ul class="nav nav-pills d-block" id="pills-tab3" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a href="<?= $path; ?>home/query" class="nav-link list-actions active"
                                                   id="all-notes">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <ul class="nav nav-pills d-block group-list" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a href="<?= $path; ?>home/query/pending"
                                                   class="nav-link list-actions g-dot-warning"
                            ...
                            <div id="ct" class="note-container note-grid">
                                <?php
                                if (count($CustomerSupportInfo) > 0) {
                                    foreach ($CustomerSupportInfo as $value) { ?>
                                        ...
                                        <div class="note-item all-notes note-<?= $class ?>">
                                            <div class="note-inner-content">
                                                ...
                                                <div class="note-footer">
                                                    ...
                                                    <a>
                                                        <svg onclick="Important_query(<?= $value['UID'] ?>,<?= $value['Featured'] ?>)"
                                                    ...
                                                    <!--                                                <svg  onclick="Delete_query(--><?php //echo $value['UID']?>
                                                    <!--                                                )"-->
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-8 col-md-8 text-center">
                                                <img class="querynotfoundimage" src="<?= $template ?>no-record_found.png" alt="No_Record_Found">
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-8 col-md-8 text-center">
                                            <div id="loaderView" style="display: none"
...
<script>
    ...
    //function Delete_query(UID){
    //    $(document).ready(function () {
    //        var ID = UID;
    //
    //        $.ajax({
    //            url: "<? //= $path; ?>//home/delete_status_query",
    //            type: "POST",
    //            dataType: "json",
    //            data: {
    //                UID: ID,
    ...
    // $('#QueryBoxModel').on('click', function() {
    //     $('#btn-n-save').hide();
    //     $('#btn-n-add').show();
    // });
