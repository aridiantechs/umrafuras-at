                                ...
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <div class="pink-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>hotel/hotel_category_wise" target="_blank"> Read
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info w-100">
                                        ...
                                        <h6 class="value text-xl-right text-lg-right text-md-right text-right">Hotel With Month Wise</h6>
                                        <div class="yellow-box rs-btn text-center mt-2 float-xl-right float-lg-right float-md-right float-right">
                                            <a href="<?= $path ?>hotel/hotel_month_wise" target="_blank"> Read
                                                More</a></div>
                                    </div>
                                </div>
                            </div>
