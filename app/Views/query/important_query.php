                    ...
                    <div class="app-container">
                        ...
                        <div class="app-note-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12 mt-5">
                                        <ul class="nav nav-pills d-block" id="pills-tab3" role="tablist">
                                            ...
                                            <li class="nav-item"> <?php if ($class == "important") {
                                                    $active = "active";
                                                } else {
                                                    $active = "";
                                                } ?>
                                                <a href="<?= $path; ?>home/query/important"
                                                   class="nav-link list-actions <?= $active ?> " id="note-fav">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div id="ct" class="note-container note-grid">
                                <?php foreach ($ImportantQuery as $value) { ?>


                                    <div class="note-item all-notes ">
                                        <div class="note-inner-content">
                                            <div class="note-content">
                                                <p class="note-title" data-noteTitle="Receive Package">
                                                    <?php
