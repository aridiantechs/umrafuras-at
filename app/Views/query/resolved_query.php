                    ...
                    <div class="app-container">
                        ...
                        <div class="app-note-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12 mt-5">
                                        ...
                                        <ul class="nav nav-pills d-block group-list" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a href="<?= $path; ?>home/query/resolved"  <?php if($class=="resolved") {$active = "active"; } else{ $active="";} ?>
                                                   class="nav-link list-actions  <?=$active?> g-dot-primary" id="note-personal">Resolved</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <div id="ct" class="note-container note-grid">
                                ...
                                <?php foreach ($ResolvedQuery as $value) { ?>
