                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="name" name="name" placeholder="Agent Name"
                                                               value="<?=( (isset($session['PilgrimSearchFilter']['Agent'])) ? $session['PilgrimSearchFilter']['Agent'] : '' )?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function(){
        var dataTable = $('#MainRecords').DataTable({
            ...
            "ajax":{
                url:"<?= $path ?>pilgrim/fetch_pilgrims",
                type:"POST",
                data:function ( data ) {
