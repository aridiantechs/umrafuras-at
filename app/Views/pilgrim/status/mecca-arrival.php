...
$inputs = array();
$inputs['mecca-arrival-driver-name'] = array("type" => "text", 'desc' => 'Driver Name','value'=> $finalMeta['allow-tpt-mecca-driver-name']);
$inputs['mecca-arrival-driver-number'] = array("type" => "number", 'desc' => 'Driver #','value'=> $finalMeta['allow-tpt-mecca-driver-contact-number']);
$inputs['mecca-arrival-vehicle-number'] = array("type" => "text", 'desc' => 'Vehicle #','value'=> $finalMeta['allow-tpt-mecca-vehicle-number']);
$inputs['mecca-arrival-actual-no-of-seats'] = array("type" => "number", 'desc' => 'Actual No Of Seats','value'=> $finalMeta['allow-tpt-mecca-no-of-seats']);


$inputs['mecca-arrival-check-out-date'] = array("type" => "date", 'desc' => 'Check Out Date');
$inputs['mecca-arrival-check-out-time'] = array("type" => "time", 'desc' => 'Check Out Time');
$inputs['mecca-arrival-departure-time'] = array("type" => "time", 'desc' => 'Departure Time');
$inputs['mecca-arrival-transport-destination'] = array("type" => "text", 'desc' => 'Transport Destination');
$inputs['mecca-arrival-room-no'] = array("type" => "text", 'desc' => 'Room No');
$inputs['mecca-arrival-pickup-point'] = array("type" => "text", 'desc' => 'Pickup Point');

echo '<input type="hidden" id="user_id" name="pilgrim_meta[mecca-arrival-user-id]" value=' . $session['id'] . '>';
...
$selects = array();
//$selects['mecca_arrival-status'] = array('desc' => 'Status');
$selects['mecca-arrival-brn-no'] = array('desc' => 'BRN no/Cash');
$selects['mecca-arrival-actual-hotel'] = array('desc' => ' Actual Hotel', 'selected' => 'mecca-arrival-actual-hotel');
foreach ($selects as $key => $name) {
    if ($key == 'mecca-arrival-brn-no') {
        echo '
        <div class="col-md-3">
    ...
    } else if ($key == 'mecca-arrival-actual-hotel') {
        echo '
        <div class="col-md-3">
            <div class="form-group mb-4">
                <label for="' . $name['desc'] . '">' . $name['desc'] . '</label><br>
...
echo ' <div class="col-md-4">
            <div class="form-group mb-4">
                <label for="Arrival Transport Company">Transport Company</label><br> 
                 <select class="form-control validate[required]" id="mecca_arrival_transport_company"  name="pilgrim_meta[mecca-arrival-transport-company]">
...
foreach ($Voucher_pilgrim as $record) {
    ...
    $pilgrimHTML .= ' <tr>        
                                    ...
                                    <td>' . ((isset($PilgrimMeta['mecca-arrival-driver-name'])) ? $PilgrimMeta['mecca-arrival-driver-name'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['mecca-arrival-driver-number'])) ? $PilgrimMeta['mecca-arrival-driver-number'] : '-') . '</td>
                                     <td>' . ((isset($PilgrimMeta['mecca-arrival-vehicle-number'])) ? $PilgrimMeta['mecca-arrival-vehicle-number'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['mecca-arrival-actual-no-of-seats'])) ? $PilgrimMeta['mecca-arrival-actual-no-of-seats'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['mecca-arrival-brn-no'])) ? $PilgrimMeta['mecca-arrival-brn-no'] : '-') . '</td>                                 
                                 <td>' . ((isset($PilgrimMeta['mecca-arrival-transport-company'])) ? OptionName($PilgrimMeta['mecca-transport-company']) : '-') . '</td>
