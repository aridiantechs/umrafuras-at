...
$inputs = array();
//$inputs['allow-tpt-jeddah-time'] = array("type"=>"time", 'desc'=>'Hotel Time');
$inputs['allow-tpt-jeddah-driver-contact-number'] = array("type"=>"number", 'desc'=>'Driver Contact Number');
$inputs['allow-tpt-jeddah-driver-name'] = array("type"=>"text", 'desc'=>'Driver Name');
$inputs['allow-tpt-jeddah-no-of-seats'] = array("type"=>"number", 'desc'=>'No Of Seats ');
$inputs['allow-tpt-jeddah-pickup-location'] = array("type"=>"text", 'desc'=>'Pickup Location');
$inputs['allow-tpt-jeddah-pickup-time'] = array("type"=>"time", 'desc'=>'Pickup Time');
$inputs['allow-tpt-jeddah-dropoff-location'] = array("type"=>"text", 'desc'=>'Drop off location');
$inputs['allow-tpt-jeddah-vehicle-number'] = array("type"=>"text", 'desc'=>'Vehicle Number');
echo '<input type="hidden" name="pilgrim_meta[RequestedStatus]" id="RequestedStatus" value="'.$RequestedStatus.'">';
echo '<input type="hidden" id="user_id" name="pilgrim_meta[allow-tpt-jeddah-user-id]" value=' .$session['id'] . '>';
...
$selects['allow-tpt-jeddah-brn-no'] = array('desc' => ' BRN No/Cash');
...
echo ' <div class="col-md-3">
            <div class="form-group mb-4">
                <label for="Arrival Transport Company">Transport Company</label><br> 
                 <select class="form-control validate[required]" id="allow-tpt-jeddah-transport-company"  name="pilgrim_meta[allow-tpt-jeddah-transport-company]">
                  <option value="">Please Select</option>';
...
echo ' <div class="col-md-3">
            <div class="form-group mb-4">
                <label for="Arrival Transport Type">Transport Type</label><br> 
                 <select class="form-control validate[required]" id="allow-tpt-jeddah-transport-type"  name="pilgrim_meta[allow-tpt-jeddah-transport-type]">
                  <option value="">Please Select</option>
                  '.$Transports.'  ';
...
foreach ($Voucher_pilgrim as $record) {
    ...
    $pilgrimHTML .= ' <tr>        
                                   ...
                                   <!--<td>' . ((isset($PilgrimMeta['allow-tpt-jeddah-time'])) ? TIMEFORMAT($PilgrimMeta['allow-tpt-jeddah-time']) : '-') . '</td>--> 
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-jeddah-driver-contact-number'])) ? $PilgrimMeta['allow-tpt-jeddah-driver-contact-number'] : '-') . '</td>
                                     <td>' . ((isset($PilgrimMeta['allow-tpt-jeddah-vehicle-number'])) ? $PilgrimMeta['allow-tpt-jeddah-vehicle-number'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-jeddah-driver-name'])) ? $PilgrimMeta['allow-tpt-jeddah-driver-name'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-jeddah-no-of-seats'])) ? $PilgrimMeta['allow-tpt-jeddah-no-of-seats'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-jeddah-transport-company'])) ? OptionName($PilgrimMeta['allow-tpt-jeddah-transport-company']) : '-') . '</td>
                                </tr>';
