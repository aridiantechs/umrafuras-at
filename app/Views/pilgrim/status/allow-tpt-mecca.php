...
$inputs = array();
//$inputs['allow-tpt-mecca-time'] = array("type"=>"time", 'desc'=>'Hotel Time');
$inputs['allow-tpt-mecca-driver-contact-number'] = array("type"=>"number", 'desc'=>'Driver Contact Number');
$inputs['allow-tpt-mecca-driver-name'] = array("type"=>"text", 'desc'=>'Driver Name');
$inputs['allow-tpt-mecca-no-of-seats'] = array("type"=>"number", 'desc'=>'No Of Seats ');
$inputs['allow-tpt-mecca-pickup-location'] = array("type"=>"text", 'desc'=>'Pickup Location');
$inputs['allow-tpt-mecca-pickup-time'] = array("type"=>"time", 'desc'=>'Pickup Time');
$inputs['allow-tpt-mecca-dropoff-location'] = array("type"=>"text", 'desc'=>'Drop off location');
$inputs['allow-tpt-mecca-vehicle-number'] = array("type"=>"text", 'desc'=>'Vehicle Number');

echo '<input type="hidden" name="pilgrim_meta[RequestedStatus]" id="RequestedStatus" value="'.$RequestedStatus.'">';
echo '<input type="hidden" id="user_id" name="pilgrim_meta[allow-tpt-mecca-user-id]" value=' .$session['id'] . '>';
...
$selects['allow-tpt-mecca-brn-no'] = array('desc' => 'BRN no/Cash');
...
echo ' <div class="col-md-3">
            <div class="form-group mb-4">
                <label for="Arrival Transport Company">Transport Company</label><br> 
                 <select class="form-control validate[required]" id="allow-tpt-mecca-transport-company"  name="pilgrim_meta[allow-tpt-mecca-transport-company]">
                  <option value="">Please Select</option>';
...
foreach ($Voucher_pilgrim as $record) {
    ...
    $pilgrimHTML .= ' <tr>     
                                   ...
                                   <!-- <td>' . ((isset($PilgrimMeta['allow-tpt-mecca-time'])) ? TIMEFORMAT($PilgrimMeta['allow-tpt-mecca-time'] ): '-') . '</td>-->
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-mecca-driver-contact-number'])) ? $PilgrimMeta['allow-tpt-mecca-driver-contact-number'] : '-') . '</td>
                                     <td>' . ((isset($PilgrimMeta['allow-tpt-mecca-vehicle-number'])) ? $PilgrimMeta['allow-tpt-mecca-vehicle-number'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-mecca-driver-name'])) ? $PilgrimMeta['allow-tpt-mecca-driver-name'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-mecca-no-of-seats'])) ? $PilgrimMeta['allow-tpt-mecca-no-of-seats'] : '-') . '</td>
                                    <td>' . ((isset($PilgrimMeta['allow-tpt-mecca-transport-company'])) ? OptionName($PilgrimMeta['allow-tpt-mecca-transport-company']) : '-') . '</td>
                               </tr>';
