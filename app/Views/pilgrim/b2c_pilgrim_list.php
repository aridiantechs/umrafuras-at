    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">B2C Client
                    <?php
                    if ($CheckAccess['umrah_client_b2c_add_new']) {
                        echo'<a type="button" class="btn btn_customized btn-sm float-right"
                                href="'.$path.'pilgrim/new">Add New
                        </a>';
                    } ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="PassportNumber"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="GroupCode" name="GroupCode"
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="MainRecords" class="display table table-hover non-hover display nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>#</th>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        var dataTable = $('#MainRecords').DataTable({
            ...
            "ajax": {
                url: "<?= $path ?>pilgrim/fetch_b2c_pilgrims",
                type: "POST",
                data: function (data) {
