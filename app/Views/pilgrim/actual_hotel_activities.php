...
$SessionFilters = session();
$SessionFilters = $SessionFilters->get('ActualHotelActivitiesSessionFilter');
$Completed = 'no';
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Actual Hotel Activities For Pilgrims
                </h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="ActualHotelActivitiesFiltersFormSubmit('ActualHotelActivitiesSearchFiltersForm'); return false;"
                      class="section contact" id="ActualHotelActivitiesSearchFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="ActualHotelActivitiesSessionFilter">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mx-auto">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12"
                                                             id="ActualHotelActivitiesSessionAjaxFilter"></div>
                                                        <div class="col-md-12" id="FilterButtons">
                                                            <div class="form-group float-right">
                                                                <button onclick="ActualHotelActivitiesFiltersFormSubmit('ActualHotelActivitiesSearchFiltersForm');"
                                                                        id="btnsearch" type="button"
                                                                        class="btn btn-success">
                                                                    Search
                                                                </button>
                                                                <button onclick="ClearSession('ActualHotelActivitiesSessionFilter');"
                        ...
                        <div class="header"><?php
                            ...
                            <div class="header-body" style="width: 100%;">
                                <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                                    <table id="ActualHotelActivitiesRecord"
                                        ...
                                        /*                                        //echo"<pre>";  print_r($data['records']);
                                                                                ...
                                                                                foreach ($records as $record) {
                                                                                    ...
                                                                                    $Voucher_pilgrim = $VoucherPilgrim->CountActualHotelVoucherListPilgrimStatus($record['VoucherID'],$record['UID']);

                                                                                    $class = '';
                                                                                    $Remaing =$record['TotalPax'] - count($Voucher_pilgrim);
                                                                                    if($Remaing == 0)  { $class = '  alert alert-success';}

                                                                                    if(DATEFORMAT($TodaysDate)  > DATEFORMAT($record['CheckIn']) && $Remaing > 0)
                                                                                    {
                                        ...
                                        //                                            echo"<pre>";  print_r($record);
                                                                                    echo '
                                                                                        <tr class="'.$class.'">
                                                                                            ...
                                                                                            <td>' . OptionName($record['RoomType']) . '</td>
                                                                                    ...
                                                                                    if(CityName($record['City']) == 'Mecca')  {
                                                                                        echo '<a class="dropdown-item" onclick="LoadModal(\'pilgrim/status/index\',\'' . $record['VoucherID'] . ':check-in-mecca:'. $record['UID'].':actual \',\'modal-xl\');">Check In Mecca</a>';

                                                                                    }else if(CityName($record['City']) == 'Medina') {
                                                                                        echo '<a class="dropdown-item" onclick="LoadModal(\'pilgrim/status/index\',\'' . $record['VoucherID'] . ':check-in-medina:'. $record['UID'].':actual \',\'modal-xl\');">Check In Medina</a>';

                                                                                    }else if(CityName($record['City']) == 'Jeddah') {
                                                                                        echo '<a class="dropdown-item" onclick="LoadModal(\'pilgrim/status/index\',\'' . $record['VoucherID'] . ':check-in-jeddah:'. $record['UID'].':actual  \',\'modal-xl\');">Check In Jeddah</a>';
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#ActualHotelActivitiesRecord').DataTable({
            "processing": true,
            "searching": false,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ Actual Hotel Activities",
                "info": "Showing _START_ to _END_ of _TOTAL_ Actual Hotel Activities",
            },
            "ajax": {
                url: "<?= $path ?>pilgrim/fetch_actual_hotel_activities",
                type: "POST"
            },
            "columnDefs": [
                {
    ...
    function ActualHotelActivitiesFiltersFormSubmit(parent) {

        var data = $("form#" + parent).serialize();
        var rslt = AjaxResponse('filters_session/create_filters_session', data);
        if (rslt.status == 'success') {

            GridMessages(parent, 'ActualHotelActivitiesSessionAjaxFilter', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                location.reload();
            }, 500);
        }
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            GridMessages('ActualHotelActivitiesSearchFiltersForm', 'ActualHotelActivitiesSessionAjaxFilter', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                location.reload();
            }, 500);
        }
