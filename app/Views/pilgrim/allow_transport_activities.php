...
$SessionFilters = $SessionFilters->get('AllowTransportSessionFilters');
$Completed = 'no';
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form onsubmit="AllowTransportActivitiesFiltersFormSubmit('AllowTransportActivitiesFiltersForm'); return false;"
                      class="section contact" id="AllowTransportActivitiesFiltersForm">
                    <input type="hidden" name="SessionKey" id="SessionKey" value="AllowTransportSessionFilters">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12"
                                                     id="AllowTransportActiviitesAjaxResult"></div>
                                                <div class="col-md-12" id="FilterButtons">
                                                    <div class="form-group float-right">
                                                        <button onclick="AllowTransportActivitiesFiltersFormSubmit('AllowTransportActivitiesFiltersForm');"
                                                                id="btnsearch" type="button"
                                                                class="btn btn-success">
                                                            Search
                                                        </button>
                                                        <button onclick="ClearSession('AllowTransportSessionFilters');"
                        ...
                        <div class="header"><?php
                            ...
                            <div class="header-body" style="width: 100%;">
                                <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                                    <table id="AllowTransportActivitiesRecord"
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        var dataTable = $('#AllowTransportActivitiesRecord').DataTable({
            ...
            "ajax": {
                url: "<?= $path ?>pilgrim/fetch_allow_transport_activities",
                type: "POST"
            },
            "columnDefs": [
                {
    ...
    function AllowTransportActivitiesFiltersFormSubmit(parent) {

        var data = $("form#" + parent).serialize();
        var rslt = AjaxResponse('filters_session/create_filters_session', data);
        if (rslt.status == 'success') {

            GridMessages(parent, 'AllowTransportActiviitesAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                location.reload();
            }, 500);
        }
    ...
    function ClearSession(SessionKey) {
        ...
        if (rslt.status == 'success') {
            GridMessages('AllowTransportActivitiesFiltersForm', 'AllowTransportActiviitesAjaxResult', 'alert-success', rslt.msg, 250);
            setTimeout(function () {
                location.reload();
            }, 500);
        }
