                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="AgentName"
                                                            ...
                                                            foreach ($AllAgents as $Agent) {
                                                                $selected = (($session['PilgrimSearchFilter']['AgentName']) == $Agent['UID'] ? 'selected' : '');
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="FullName" name="FullName"
                                                               ...
                                                               value="<?= ((isset($session['PilgrimSearchFilter']['FullName'])) ? $session['PilgrimSearchFilter']['FullName'] : '') ?>">
                                                    </div>
                                                </div>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        var dataTable = $('#MainRecords').DataTable({
            ...
            "ajax": {
                url: "<?= $path ?>pilgrim/fetch_b2b_pilgrims",
                type: "POST",
                data: function (data) {
