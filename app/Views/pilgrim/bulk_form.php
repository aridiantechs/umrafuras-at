                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Add Group & Pilgrims <span id="ExportPackage"> </span>
...
<!--                                                </div>-->
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input value="0" class="form-control validate[required]" type="number" min="0" name="RefundAmount" id="RefundAmount">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
    ...
    function RequstedBulkPilgrimFormHTML() {
        ...
        for (let i = 1; i <= paxtotal; i++) {
            ...
            html += '<div class="row">\n' +
                ...
                '<div class="col-md-2"><div class="form-group"><label for="address">FirstName</label><input type="text" class="form-control mb-4  validate[required]" id="FirstName" name="Pilgrim[FirstName][]" placeholder="First Name"></div></div>\n' +
                '<div class="col-md-2"><div class="form-group"><label for="location">Middle Name</label><input type="text" class="form-control mb-4  validate[required]" id="MiddleName" name="Pilgrim[MiddleName][]" placeholder="Middle Name"></div></div>\n' +
                '<div class="col-md-2"><div class="form-group"><label for="location">Last Name</label><input type="text" class="form-control mb-4  validate[required]" id="LastName" name="Pilgrim[LastName][]" placeholder="Last Name"></div></div>\n' +
                ...
                '<div class="col-md-3"><div class="form-group"><label for="email">Passport Size Picture</label><input type="file"  name="Pilgrim[PassportSizePicture][]" id="PassportSizePicture"/></div></div>\n' +
                '<div class="col-md-3"><div class="form-group"><label for="City">Vaccination Certificate</label><input type="file"  name="Pilgrim[VaccinationCertificate][]" id="VaccinationCertificate"/></div></div>\n' +
                '</div>\n' +
                '</div>\n' +
                '</div>\n' +
                '</div>\n' +
