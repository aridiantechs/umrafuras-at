...
<div class="card">
    ...
    <div class="card-body">
        <form enctype="multipart/form-data" method="post" action="#"
            ...
            <input type="hidden" name="Flag" id="Flag" value="Arrival">
            <div class="row">
...
<div class="table-responsive mb-4 mt-4 datatableparentdiv">
    <table id="ElmRecord" class="table table-hover non-hover" style="width:100%">
        <thead>
        <tr>
            <th>#</th>
            <th>Group Name</th>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        var dataTable = $('#ElmRecord').DataTable({
            "processing": true,
            "searching": false,
            "responsive": true,
            ...
            "order": [],
            "language": {
                "lengthMenu": "Show _MENU_ All Arrival ELM",
                "info": "Showing _START_ to _END_ of _TOTAL_ All Arrival ELM",
            },
            "ajax": {
                url: "<?= $path ?>pilgrim/fetch_all_melm",
                type: "POST",
                data: function (data) {}
            },
            "columnDefs": [
