    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head"> Expire Booking
                    ...
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="MainRecords" class="table table-hover non-hover display nowrap" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>400 SAR</td>
                                <td>qasim@email.com</td>
                                <td>+93101212321</td>
                                <td>Saad</td>
                                <td>30</td>
                                <td>Awais (Sale Agent)</td>
                                <td>B2B</td>
                            ...
                            <tr>
                                ...
                                <td>JED TO DXB</td>
                                <td>Return</td>
                                <td><?= DATEFORMAT(date('16-m-Y')) ?></td>
                                <td>600 SAR</td>
                                <td>kashif@email.com</td>
                                <td>+93101245789</td>
                                <td>Nadeem</td>
                                <td>50</td>
                                <td>Twitter</td>
                            ...
                            <tr>
                                ...
                                <td>DXB TO ISB</td>
                                <td>One Way</td>
                                <td><?= DATEFORMAT(date('14-m-Y')) ?></td>
                                <td>500 SAR</td>
                                <td>Abbas@email.com</td>
                                <td>+93101212546</td>
                                <td>Nadeem</td>
                                <td>29</td>
                                <td>Instagram</td>
