    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Ticket Issue
                    ...
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="MainRecords" class="table table-hover non-hover display nowrap" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td><?= date('H:i:A') ?></td>
                                <td><?= date('H:i:A') ?></td>
                                <td><?= DATEFORMAT(date('04-m-Y')) ?></td>
                                <td><?= date('H:i:A') ?></td>
                                <td>MNB77</td>
                                <td>AL Nafrah Travel</td>
                                <td>Pakistan</td>
                                <td>Multan</td>
                                <td>GMGM18IT</td>
                                <td>345GTY</td>
                                ...
                                <td>ISB TO JED</td>
                                <td>Round Trip</td>
                                <td><?= DATEFORMAT(date('25-m-Y')) ?></td>
                                <td>650 SAR</td>
                                <td>Junaid@email.com</td>
                                <td>+9310444578</td>
                                <td>Hammad</td>
                                <td>Saudi Arabia </td>
                                <td>Awais (Accountant)</td>
                                <td>45</td>
                                <td>LinkedIn</td>
                                <td>B2C</td>
                                <td>lalaIntlTravel.com</td>
                                <td>Booked</td>
                                <td>
                                    <div class="btn-group">
                                        <button type="button"
