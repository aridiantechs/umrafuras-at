                                                    ...
                                                    <div class="mail-item-heading social collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapseThree" aria-expanded="false">
                                                        <div class="mail-item-inner">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="f-body">
                                                                    <div class="meta-mail-time">
                                                                        <p class="user-email" data-mailTo="">hello</p>
                                                                    </div>
                                                                    <div class="meta-title-tag">
                                                                        <p class="mail-content-excerpt" data-mailDescription='{"ops":[{"insert":"Lorem ipsum dolor sit amet, consectetur adipiscing elit. \n"}]}'>
                                                                            ...
                                                                            <span class="mail-title" data-mailTitle="Promotion Page">helooo</span> 
                                                                        </p>
                                                                        <!-- <div class="tags">
                                                                            <span class="g-dot-primary"></span>
                                                                            <span class="g-dot-warning"></span>
                                                                        ...
                                                                        <p class="meta-time align-self-center">12345</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="attachments">
                                                            <span class="">abc123</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="compose-box">
                                            <div class="compose-content">
                                                <form method="post" action="<?= $path ?>home/saveEmail" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-12">
