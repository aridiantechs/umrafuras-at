    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Visa Not Printed</h4>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <form class="section contact" id="VisaNotPrintedSearchFilter">
...
<!--                                                </div>-->
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                               value="<?=( (isset($session['VisaNotPrintedSearchFilter']['name'])) ? $session['VisaNotPrintedSearchFilter']['name'] : '' )?>"
                                                               placeholder="Name">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="passport_number"
                                                               value="<?=( (isset($session['VisaNotPrintedSearchFilter']['passport_number'])) ? $session['VisaNotPrintedSearchFilter']['passport_number'] : '' )?>"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group float-right">
                                                        <button onclick="UpdateFilters('VisaNotPrintedSearchFilter'); return false;"
                                                                class="btn btn-success">Search
                                                        </button>
                                                        <button onclick="ClearFilters('VisaNotPrintedSearchFilter'); return false;"
                        ...
                        <table id="MainRecords" class="table table-hover non-hover  display nowrap" style="width:100%">
                            ...
                            foreach ($records as $record) {
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                    <a class="dropdown-item" href="#" onclick="LoadModal(\'mofa/upload_visa_form\', ' . $record['UID'] . ')">Upload Visa</a>
                                </div>';
                                echo '
                                <tr>
                                    <td>' . Code('UF/VNP/',$record['UID']) . '</td>                                 
...
<script type="application/javascript">
    ...
    setTimeout(function () {
        $('<a target="_blank" href="<?=$path?>exports/visa_not_printed_list" class="dt-filter-btn">Export</a>').appendTo(".dataTables_wrapper .dataTables_filter");
    }, 100);
