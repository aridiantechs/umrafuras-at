    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4 class="page-head">Sales Officer
                    <button type="button" class="btn btn_customized btn-sm float-right"
                            onclick="LoadModal('sales/main_form', 0,'modal-lg')">Add New
                    </button>
                </h4>
            </div>
                    ...
                    <div class="table-responsive mb-4 mt-4 datatableparentdiv">
                        <table id="MainRecords" class="table table-hover non-hover display nowrap" style="width:100%">
                            ...
                            foreach ($records as $record) {
                                ...
                                $actions .= ' <a class="dropdown-item" href="#" onclick="LoadModal(\'sales/staff/initial_training_staff\', '. $record['UID'].',\'modal-lg\')">Initial Training Staff</a>';
                                $actions .= ' <a class="dropdown-item" href = "#" onclick="LoadModal(\'sales/staff/project_threshold\', '. $record['UID'].',\'modal-lg\')"> Project / Threshold</a >';
                                $actions .= '</div>';
