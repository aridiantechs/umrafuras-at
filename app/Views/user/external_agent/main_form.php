...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><?= $head ?> External Agent</h5>
...
<form enctype="multipart/form-data" class="validate" method="post" action="#" id="AgentAddForm" name="AgentAddForm">
    <div class="modal-body">
        ...
        <input type="hidden" id="Type" name="Type" value="external_agent">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select class="form-control validatexxx[required]" id="SalesAgent"
                            name="SalesAgent">
                        <?php
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="file"
                           class="form-control <?= (isset($profile['UID']) ? '' : 'validatexxx[required]') ?>"
                           id="AgentLogo"
