    ...
    var MorrisCharts = function() {};
        ...
        MorrisCharts.prototype.init = function() {
            ...
            var $stckedData  = [
                ...
                { y: 'July', a: 50,  b: 40, c: 85 },
                { y: 'Aug', a: 75,  b: 65, c: 52 },
                { y: 'Sep', a: 50,  b: 40, c: 77 },
                { y: 'Oct', a: 75,  b: 65, c: 90 },
                { y: 'Nov', a: 100, b: 90, c: 130 },
                { y: 'Dec', a: 80, b: 65, c: 95 }
            ];
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B','Series C'], ['#ffffff', '#ebeff2','#9aa1f2']);
