  ...
  Echart.dashboardEcharts = function() {
    ...
    if($("#platform_type_dates_donut").length){
      ...
      var option_dt = {
        ...
        options : [
          {
            color: ['#e328af','#5f5b60','#00cffd','#19bd03','#3246d2'],
            title : {
              text: '',
              subtext: ''
            },
            ...
            toolbox: {
              show : true,
              color : ['#19bd03','#bdbdbd','#bdbdbd','#bdbdbd'],
              feature : {
                mark : {show: false},
            ...
            series : [
              {
                ...
                data:[{value: 35,  name:'-0.55%'}, {value: 16,  name:'-0.75%'}, {value: 27,  name:'-0.45%'}, {value: 29,  name:'+2.5%'}, {value: 12,  name:'-0.5%'}]
              }
            ]
          },
          {
            series : [
              {
                name:'2 Star',
                type:'pie',
                data:[{value: 42,  name:'-0.55%'}, {value: 51,  name:'-0.75%'}, {value: 39,  name:'-0.45%'}, {value: 25,  name:'+2.5%'}, {value: 9,  name:'-0.5%'}]
              }
            ]
          },
          {
            series : [
              {
                name:'3 Star',
                type:'pie',
                data:[{value: 29,  name:'-0.55%'}, {value: 16,  name:'-0.75%'}, {value: 24,  name:'-0.45%'}, {value: 19,  name:'+2.5%'}, {value: 5,  name:'-0.5%'}]
              }
            ]
          },
